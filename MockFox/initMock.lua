...
if GrDaemon then
  --DEBUGNOW GrTools():EnableTextureStreaming()
...
if GrDaemon then
  --DEBUGNOW local grDaemon=GrDaemon{name="GrDaemon"}
end
if GrDaemon then
  if platform=="Windows"then
    if deviceName=="directx9"then
...
if PadMapping then
  --DEBUGNOW local e=PadMapping()
end
if ReplayService then
   --DEBUGNOW ReplayService.Boot()
end
...
if PhDaemon then
  ...
  PhDaemon.SetMaxRigidBodyNum(500)
   --DEBUGNOW local e=PhDaemon()
end
if SimDaemon then
   --DEBUGNOW local e=SimDaemon()
   --DEBUGNOW e.defaultViewPort="MainViewport"
end
if DesDaemon then
   --DEBUGNOW local e=DesDaemon()
end
if NtDaemon then
  NtDaemon.Create()
end
...
if UiDaemon then
   --DEBUGNOW local e=UiDaemon{name="UiDaemon"}
end
if LangDaemon then
   --DEBUGNOW local e=LangDaemon{name="LangDaemon"}
end
if SubtitlesDaemon then
   --DEBUGNOW local e=SubtitlesDaemon{name="SubtitlesDaemon"}
end
if SubtitlesCommand then
  --DEBUGNOW  local e=SubtitlesDaemon.GetDefaultVoiceLanguage()
  SubtitlesCommand.SetVoiceLanguage(e)
  --DEBUGNOW  local e=AssetConfiguration.GetDefaultCategory"Language"
  SubtitlesCommand.SetLanguage(e)
end
if PreviewDaemon then
 --DEBUGNOW   local e=PreviewDaemon{}
end
if EnvironmentDaemon then
 --DEBUGNOW   local e=EnvironmentDaemon{}
  if WindManager then
   --DEBUGNOW   local e=WindManager{}
  end
end
local platform=Fox.GetPlatformName()
if GrDaemon then
