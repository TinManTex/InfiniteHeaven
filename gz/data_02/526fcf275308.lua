...
Command.SetProperty{ entity=blendFunction, property="name", value="YBlend_4x1" }


local customData = dataSet:GetData( "TppCustomBlendFunctionPlugin_4x1Param0000" )
...
local blendFunction = Command.CreateData( editor,'TppCustomBlendFunctionPlugin_4x1Param' )
