--[[FDOC
	@id CharaTppGunEmplacementEast
	@category Script Character 
	@brief 東側銃座（西側とは載っている武器が違うだけ）
]]--
...
Command.SetProperty{ entity=locator, property="scriptPath", value="Tpp/Scripts/Gimmicks/CharaTppGunEmplacement.lua" }
Command.AddPropertyElement{ entity=params.fileResources, property="resources", key="parts" }
Command.SetProperty{ entity=params.fileResources, property="resources", key="parts", value="/Assets/tpp/parts/weapon/hew/hw01_tpod0_def.parts" }
Command.EndGroup()
--]]
...
AddGadgetPlugins = function( chara )
	...
	chara:AddPlugins{
		...
		TppMechaInventoryPlugin {
			name			= "NewInventory",
			weaponId		= "WP_hw03_v00",
			connectPointName = "CNP_awp_a",
			rotateSkeletonName = "SKL_010_GUN",
		},
		...
		TppGadgetAttackEmplacementActionPlugin{
			...
			boneRotationType	= "ROT_BONE_BOTH",
			boneNameDirection	= "SKL_004_GUNBASE",
			boneNameAngle		= "SKL_010_GUN",
			isSleepStart	= true,
		},
