...
-- ローカルリフレクション
GrRenderPlugin.AddPlugin( GrPluginReflectMap { pluginName="REFLECT_MAP", priority=870} )
...
-- Wireframe描画の切り替え用
-- GrTools.SwitchRenderMode( { execMode="wireframe" } )
-----------------------------------------------------------------------------------------------
...
-- Pseudoshade描画の切り替え用
-- GrTools.SwitchRenderMode( { execMode="pseudoshade" } )
-----------------------------------------------------------------------------------------------
