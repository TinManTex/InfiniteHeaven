...
local O="/Assets/mgo/parts/objective/floppy_disk.parts"local k="CNP_HEAD"local E=Vector3{0,.15,0}
local I=1
local t=16
local G=32
local u=64
...
local T
local P
function this.AddParm(e)e:AddDynamicProperty("String","MarkerName")
  e.MarkerName="A"e:AddDynamicProperty("String","GenericPOITag")
  e.GenericPOITag="GENERIC_01"end
function this.RemoveParm(e)e:RemoveDynamicProperty"MarkerName"e:RemoveDynamicProperty"GenericPOITag"end
function this.Construct(n)
  if not S then
    local e=n:GetParm().GenericPOITag
    local e={type=TppPoi.POI_TYPE_GENERIC,tags={"OBJECTIVE",e}}S=Utils.POIinitialize(n,e)
  end
  i=0
  C=1.5
  a=-1
  ...
  o=false
  r=-1
  local a=n:GetInitialTransform()n:SetTransform(a)d=a:GetTranslation()
  if t==nil then
    ...
    if not e then
      ...
      n:AttachParts(t)MgoParts.SetVisibility(t,true)
    end
  end
...
function this.Destruct(a)Utils.POIdestruct(a,S)S=nil
  if t then
...
function this.Activate(e)l=true
end
function this.Deactivate(e)l=true
end
function this.ExecuteIdle(e)h(e,o,r)
end
function this.ExecuteHost(t)
  ...
  if t:GetTable().AttachedToPlayerIndex<0 and a>0 then
    ...
    if a<=0 and c==false then
      ...
      this.LineChecker.OnResultReady(t,true,d,nil)
...
function this.ExecuteClient(e)h(e,o,r)
end
function this.ExecuteScript(e,e)
end
function this.ProcessSignal(a,i)
  if i==nil then
    return
  end
  ...
  if Mgo.IsHost()and c==A.INTERACTION then
    ...
    elseif o==MgoActor.ACTOR_PLAYER_ACTION_DROP then
      ...
      this.LineChecker.RequestLineCheck(a,T,t,n,MgoActor.GEO_COL_F_CHK_ALL,MgoActor.CATEGORY_CHARA,MgoActor.GEO_COL_ATR_PLAYER)
    end
  elseif c==A.HOST_STATE then
    local e=nil
    o=i:SerializeBoolean(o)r=i:SerializeInteger(r)e=i:SerializeVector3(e)m(a,o,r,e)s(a,o,r)
  end
end
function h(a,e,r)
  local l=(r~=-1)
...
function this.HandlePlayerAction(n,t,a)
...
function this.ExecuteScript(t,n)
  if not Mgo.IsHost()then
    return
  end
  if"dropFlag"==n.command then
    if t:GetTable().AttachedToPlayerIndex==n.playerIndex then
      this.HandlePlayerAction(t,n.playerIndex,MgoActor.ACTOR_PLAYER_ACTION_DROP)
    end
...
this.LineChecker={lineCheckIdInternal=MgoActor.INVALID_LINE_CHECK_ID,callbackMethodInternal=nil,RequestLineCheck=function(a,t,n,c,d,i,r,l,o)
  if this.LineChecker.lineCheckIdInternal~=MgoActor.INVALID_LINE_CHECK_ID then
    return false
  end
  this.LineChecker.callbackMethodInternal=t
  this.LineChecker.lineCheckIdInternal=a:RequestLineCheck(n,c,d,i,r,l,o)
  ...
  if this.LineChecker.callbackMethodInternal~=nil then
    this.LineChecker.callbackMethodInternal(a,l,n,t)
  end
  this.LineChecker.lineCheckIdInternal=MgoActor.INVALID_LINE_CHECK_ID
  this.LineChecker.callbackMethodInternal=nil
end}
function this.HandleCollisionResult(o,l,n,a,t)
  if l==this.LineChecker.lineCheckIdInternal then
    this.LineChecker.OnResultReady(o,n,a,t)
  end
end
