...
e.UpdateSoundFx(n,nil,l)n:SetActive(true)
end
e.Reset=e.Construct
...
e.UpdateSoundFx(i,o,0)
else
e.UpdateSoundFx(i,o,l)
end
...
function e.ValidateCapturers(e,o,t,a)
...
local o={}o.data=math.floor(.5+(l*255))
local i=m
local l=0
...
o.flags=(h+i)+l
t:EnableMarker(t:GetParm().MarkerName)t:UpdateMarker(o)
else
t:DisableMarker()
end
end
function e.UpdateSoundFx(l,e,n)
