local n={}
function n.OnEndExceptionDialogForMgoInvitationAccept()
return TppException.PROCESS_STATE.FINISH
end
function n.MgoExitRoomOnException()
...
function n.OnEndExceptionDialogForSignInUserChange()
if TppException.GetCurrentGameMode()~=TppException.GAME_MODE.MGO then
return TppException.PROCESS_STATE.FINISH
end
