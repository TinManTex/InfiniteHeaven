...
[PlayerType.MGO_QUIET]={parts={[PlayerPartsType.NORMAL]={fpk="/Assets/mgo/pack/player/parts/plparts_qui1_main.fpk",file="/Assets/mgo/parts/chara/qui/qui0_main0_mgo_v00.parts"}}},
[PlayerType.MGO_KAZ]={parts={[PlayerPartsType.NORMAL]={fpk="/Assets/mgo/pack/player/parts/plparts_kaz0_main.fpk",file="/Assets/mgo/parts/chara/kaz/kaz1_main0_mgo_v01.parts"}}}}
function a.GetPartsFpkPath(e,p)
local s
pcall(function()s=a.PlayerTypes[e].parts[p].fpk
end)
return s
end
function a.GetPartsFilePath(p,e)
local s
pcall(function()s=a.PlayerTypes[p].parts[e].file
end)
return s
end
function a.GetFaceFpkPath(p,s,e)
local s
pcall(function()s=a.PlayerTypes[p].faces[e+1].fpk
end)
return s
end
function a.GetFaceFilePath(e,s,p)
local s
