...
local r=string.sub(e,0,n-1)table.insert(t,r)e=string.sub(e,n+1)
end
end
return t
end
...
function e.DoMessage(n,o,i,a,t,r,l,d,c)
if not n then
return
end
local n=n[i]
...
local a=true
e.DoMessageAct(n,o,t,r,l,d,c,a)
end
function e.DoMessageAct(n,o,e,l,r,a,t)
if n.func then
if o(n.option)then
n.func(e,l,r,a)
end
...
function e.FillBlockArea(n,e,a,l,r,t)
for e=e,l do
n[e]=n[e]or{}
for r=a,r do
n[e][r]=t
