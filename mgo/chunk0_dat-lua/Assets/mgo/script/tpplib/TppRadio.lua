...
e.PRESET_DELAY_TIME={short=.5,mid=1.5,long=3}
function e.Play(r,a)
local a=a or{}
local t=a.radioType or"realtime"local d=a.isEnqueue
local n=a.delayTime
...
function e.EnableCommonOptionalRadio(e)
end
...
if d then
TppRadioCommand.PlayDirectGroupTableEnqueue{tableName=a,groupName=i,preDelayTime=n,noiseType=o,isOverwriteProtectionForSamePrio=r}
else
TppRadioCommand.PlayDirectGroupTable{tableName=a,groupName=i,preDelayTime=n,noiseType=o,isOverwriteProtectionForSamePrio=r}
end
end
function e.PlayDebug(n,a)
local n,i=e.GetRadioNameAndRadioIDs(n)
...
local r=e.GetCommonRadioDelay(r)or"short"local r={delayTime=r}
if i(n)or a(n)then
if o then
...
for a,e in pairs(e.COMMON_GAME_OVER_RADIO_LIST)do
...
function e.OnMessage(r,t,o,d,a,n,i)
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,r,t,o,d,a,n,i)
end
...
n=mvars.rad_gameOverRadioTable[a]
if n==nil then
n=mvars.rad_gameOverRadioTable[TppDefine.GAME_OVER_RADIO.OTHERS]
end
SubtitlesCommand.SetIsEnabledUiPrioStrong(true)
e.Play(n,{noiseType="none"})
end
...
function e._PlayDebugLine(a,e)SubtitlesCommand.DisplayText(a,"Default",e*1e3)
end
