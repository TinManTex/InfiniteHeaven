...
local e={[10010]=true,[10030]=true,[10240]=true,[10280]=true,[30050]=true,[30150]=true,[30250]=true}
...
if TppServerManager.GetFobStatus then
...
return Tpp.StrCode32Table{GameObject={{msg="Fulton",func=function(e,t,n,a)
mvars.trm_fultonInfo=mvars.trm_fultonInfo or{}
mvars.trm_fultonInfo[e]={e,t,n,a}
end,option={isExecMissionClear=true,isExecDemoPlaying=true}},{msg="FultonInfo",func=function(n,a)
mvars.trm_fultonInfo=mvars.trm_fultonInfo or{}
...
end}},Weather={{msg="WeatherForecast",func=e.TerminalVoiceWeatherForecast},{msg="Clock",sender="TerminalVoiceOnSunSet",func=e.TerminalVoiceOnSunSet},{msg="Clock",sender="TerminalVoiceOnSunRise",func=e.TerminalVoiceOnSunRise},{msg="Clock",sender="WolfHowl",func=function()
...
end}},Trap=n,Network={{msg="NoticeSneakMotherBase",func=function(n,e)
local t
if e==0 then
...
t="tpp_fob_name1"end
local a={[10010]=true,[10030]=true,[10115]=true,[10150]=true,[10151]=true,[10260]=true,[10280]=true,[11151]=true,[50050]=true}
if a[vars.missionCode]then
else
local a=true
if n==FobMode.MODE_ACTUAL then
TppMotherBaseManagement.SetMyFobEmergency{emergency=true}
TppUI.ShowAnnounceLog("fobNoticeIntruder",t)
TppUI.ShowEmergencyAnnounceLog(a)
TppUiCommand.ShowSideFobInfo("start",TppUI.ANNOUNCE_LOG_TYPE.fobNoticeIntruder)
elseif n==FobMode.MODE_SHAM then
TppMotherBaseManagement.SetMyFobEmergency{emergency=true}
TppUI.ShowAnnounceLog"fobReqPractice"TppUI.ShowEmergencyAnnounceLog(a)
TppUiCommand.ShowSideFobInfo("start",TppUI.ANNOUNCE_LOG_TYPE.fobReqPractice)
...
function e.OnMessage(t,n,r,a,_,M,o)
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,t,n,r,a,_,M,o)
end
function e.SetUp()
...
e.EnableDvcMenuByList{{menu=e.MBDVCMENU.MBM_DEVELOP_ARMS,active=true},{menu=e.MBDVCMENU.MBM_CUSTOM,active=true},{menu=e.MBDVCMENU.MBM_CUSTOM_ARMS,active=true},{menu=e.MBDVCMENU.MBM_CUSTOM_ARMS_HELI,active=true},{menu=e.MBDVCMENU.MBM_CUSTOM_ARMS_VEHICLE,active=true}}
end
end
...
function e.DoFuncByFultonTypeSwitch(e,t,r,n,o,a,d,p,S,c,T,s,u,M,_,i,E)
if Tpp.IsSoldier(e)then
return d(e,t,r,n,o,a)
elseif Tpp.IsVolgin(e)then
return p(e)
elseif Tpp.IsHostage(e)then
return S(e,t,r,n,o,a)
elseif Tpp.IsVehicle(e)then
return c(e,t,r,n,nil,a)
elseif Tpp.IsFultonContainer(e)then
return T(e,t,r,n,nil,a)
elseif Tpp.IsFultonableGimmick(e)then
return s(e,t,r,n,nil,a)
elseif Tpp.IsEnemyWalkerGear(e)then
return M(e,t,r,n,nil,a)
elseif Tpp.IsAnimal(e)then
return _(e,t,r,n,nil,a)
elseif Tpp.IsBossQuiet(e)then
return i(e,t,r,n,o,a)
elseif Tpp.IsParasiteSquad(e)then
return E(e,t,r,n,nil,a)
else
local o=Tpp.GetBuddyTypeFromGameObjectId(e)
if o then
return u(e,t,r,n,o,a)
end
end
end
function e.OnFulton(t,n,a,o,r,M,_)
if M then
mvars.trm_needHeliSoundOnAddStaffsFromTempBuffer=true
end
TppEnemy.SetRecovered(t)
TppEnemy.ExecuteOnRecoveredCallback(t,n,a,o,r,M,_)
e.DoFuncByFultonTypeSwitch(t,n,a,o,r,_,e.OnFultonSoldier,e.OnFultonVolgin,e.OnFultonHostage,e.OnFultonVehicle,e.OnFultonContainer,e.OnFultonGimmickCommon,e.OnFultonBuddy,e.OnFultonEnemyWalkerGear,e.OnFultonAnimal,e.OnFultonBossQuiet,e.OnFultonParasiteSquad)
end
...
local _=TppMotherBaseManagement.GetTempStaffStatusFromGameObject{gameObjectId=t}
local a
if r then
a=r
else
...
e.AddTempStaffFulton{staffId=a,gameObjectId=t,tempStaffStatus=_,fultonedPlayer=o}
end
...
function e.OnFultonHostage(t,n,n,o,a,r)
local _=TppMotherBaseManagement.GetTempStaffStatusFromGameObject{gameObjectId=t}
local n
if o then
n=o
...
e.AddTempStaffFulton{staffId=n,gameObjectId=t,tempStaffStatus=_,fultonedPlayer=r}
end
...
e.GIMMICK_RESOURCE_ID_TABLE={[1845465265]=t.RESOURCE_ID_EMPLACEMENT_GUN_EAST,[2207998916]=t.RESOURCE_ID_EMPLACEMENT_GUN_WEST,[1187982616]=t.RESOURCE_ID_MORTAR_NORMAL,[3601635493]=t.RESOURCE_ID_ANTI_AIR_GATLING_GUN_EAST,[20562949]=t.RESOURCE_ID_ANTI_AIR_GATLING_GUN_WEST}
function e.OnFultonGimmickCommon(a,a,a,n,a,t)
if mvars.trm_isSkipAddResourceToTempBuffer then
return
end
local a=e.GIMMICK_RESOURCE_ID_TABLE[n]
if a then
...
function e.AddTempResource(n,t,a)
local a=a or 0
...
local n={{186},{209},{210,211},{212},{213},{214},{215},{216,217},{218},{187},{185},{188,189,190,191,192,193},{194,195,196,197,198,199}}
local a={[10033]=1,[10036]=1,[10043]=1,[10080]=2,[10086]=3,[10082]=4,[10091]=5,[10195]=6,[10100]=7,[10110]=8,[10121]=9,[10070]=10,[10090]=11,[10151]=12,[10280]=13}
local t=a[t]
if t then
local t=n[t]
for n,t in ipairs(t)do
...
function e._AddUniqueVolunteerStaff(n,e)
...
local n=TppMotherBaseManagement.GenerateStaffParameter{staffType="Unique",uniqueTypeId=n}
TppMotherBaseManagement.DirectAddStaff{staffId=n,section="Wait",isNew=true,specialContract=t}
TppUiCommand.ShowBonusPopupStaff(n,e)
return true
end
...
for t,a in ipairs(e.MOTHER_BASE_SECTION_LIST)do
local n=e.RewardLangIdTable[a]
...
local n=TppMotherBaseManagement.OpenedSectionFunc
...
if(t==true)then
n{sectionFuncId=a,opened=true}
elseif t then
if t(r)then
n{sectionFuncId=a,opened=true}
else
n{sectionFuncId=a,opened=false}
end
end
end
end
...
function e.OnFultonFailedEnd(e,e,e,e)
