...
e.BUDDY_LANG_ID={[BuddyType.HORSE]="name_buddy_dh",[BuddyType.DOG]="name_buddy_dd",[BuddyType.QUIET]="marker_chara_quiet"}
e.EMBLEM_ANNOUNCE_LOG_TYPE={[Fox.StrCode32"front"]="find_em_front",[Fox.StrCode32"base"]="find_em_back",[Fox.StrCode32"word"]="find_em_string"}
function e.Messages()
...
TppSoundDaemon.ResetMute"Outro"o(t,i,s)
...
function e.ShowColorJoinAnnounceLog(n,o,t,a,i)
if gvars.ini_isTitleMode then
return
end
...
TppUiCommand.AnnounceLogViewJoinLangId(n,e,t,a,0,0,true)
end
end
function e.ShowEmergencyAnnounceLog(n)
e.ShowAnnounceLog"emergencyMissionOccur"if n==true then
...
if a then
local e=p(a)
TppUiCommand.SetMissionPhotoRadioGroupName(n,e)
end
end
end
...
if a then
if t>o then
e.ShowAnnounceLog("task_complete",t,i)
end
end
...
function e.SetTaskLastCompleted(i,n)
local e=e.GetLastCompletedFlagIndex(i)
if e then
...
local i=e.BUDDY_LANG_ID[mvars.ui_callSupportBuddyType]
if i then
local n=TppSupportRequest.GetCallBuddyGmpCost(mvars.ui_callSupportBuddyType)
e.ShowAnnounceLog("callSupportBuddyReceived",i)
TppTerminal.UpdateGMP{gmp=-n,gmpCostType=TppDefine.GMP_COST_TYPE.BUDDY}svars.supportGmpCost=svars.supportGmpCost+n
...
TppUiCommand.RegisterPauseMenuPage{GamePauseMenu.ABORT_MISSION_RETURN_TO_ACC,GamePauseMenu.SIGN_IN,GamePauseMenu.STORE_ITEM,GamePauseMenu.RECORDS_ITEM,GamePauseMenu.CONTROLS_AND_TIPS_ITEM,GamePauseMenu.OPEN_OPTION_MENU}
else
TppUiCommand.RegisterPauseMenuPage{GamePauseMenu.ABORT_MISSION_RETURN_TO_ACC}
end
else
...
elseif n then
if vars.fobSneakMode==FobMode.MODE_VISIT then
TppUiCommand.RegisterGameOverMenuItems{GameOverMenu.GAME_OVER_RESTART_HELI}
else
TppUiCommand.RegisterGameOverMenuItems{GameOverMenu.GAME_OVER_ABORT}
end
else
...
local e={GamePauseMenu.RETURN_TO_TITLE,GamePauseMenu.SIGN_IN,GamePauseMenu.RECORDS_ITEM,GamePauseMenu.CONTROLS_AND_TIPS_ITEM,GamePauseMenu.OPEN_OPTION_MENU,GamePauseMenu.GOTO_MGO}
if n then
table.insert(e,3,GamePauseMenu.STORE_ITEM)
end
TppUiCommand.RegisterPauseMenuPage(e)
end
function e.OnReload()
...
function e.OnMessage(r,s,t,o,a,i,n)
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,r,s,t,o,a,i,n)
end
