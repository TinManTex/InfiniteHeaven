mbdvc_map_location_parameter={GetLocationParameter=function(e)
  ...
  elseif e==111 then
    return{stageSize=512*1,scrollMaxLeftUpPosition=Vector3(-256,0,-320),scrollMaxRightDownPosition=Vector3(256,0,192),highZoomScale=2,middleZoomScale=1,lowZoomScale=.5,locationNameLangId="mgo_idt_MB",stageRotate=0,heightMapTexturePath="/Assets/mgo/ui/texture/map/mba0/mba0_clp.ftex",photoRealMapTexturePath="/Assets/mgo/ui/texture/map/mba0/mba0_sat_clp.ftex"}
  elseif e==113 then
    return{stageSize=512*1,scrollMaxLeftUpPosition=Vector3(512,0,-2176),scrollMaxRightDownPosition=Vector3(1024,0,-1664),highZoomScale=2,middleZoomScale=1,lowZoomScale=.5,locationNameLangId="mgo_idt_Remnant",stageRotate=0,heightMapTexturePath="/Assets/mgo/ui/texture/map/rma0/rma0_clp.ftex",photoRealMapTexturePath="/Assets/mgo/ui/texture/map/rma0/rma0_sat_clp.ftex"}
  elseif e==112 then
    return{stageSize=512*1,scrollMaxLeftUpPosition=Vector3(-1216,0,-64),scrollMaxRightDownPosition=Vector3(-704,0,448),highZoomScale=2,middleZoomScale=1,lowZoomScale=.5,locationNameLangId="mgo_idt_Savannah",stageRotate=0,heightMapTexturePath="/Assets/mgo/ui/texture/map/sva0/sva0_clp.ftex",photoRealMapTexturePath="/Assets/mgo/ui/texture/map/sva0/sva0_sat_clp.ftex"}
  end
