...
this.modVersion="224"
this.modName="Infinite Heaven MGO"
...
function this.StartIHExt()
  ...
  if not programPath then
    InfCore.Log([[WARNING: StartIHExt: Could not find IHExt.exe in MGS_TPP\mod\]],false,true)
    return
  end
...
this.modPath=this.gamePath..[[modmgo/]]--DEBUGNOW
this.paths={
  mod=this.modPath,
}
this.files={
