LightUtility={CycleLightType=function()
...
Command.SetProperty{entity=t,property="skyColor",value=o}Command.SetProperty{entity=t,property="groundColor",value=o}
else
Command.SetProperty{entity=t,property="color",value=o}
end
Command.SetProperty{entity=t,property="isOn",value=e.isOn}Command.SetProperty{entity=t,property="showObject",value=e.showObject}
end}
