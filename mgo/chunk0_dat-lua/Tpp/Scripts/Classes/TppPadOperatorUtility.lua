TppPadOperatorUtility={Init=function()
...
end,SetStickMapping=function(t,a)
local e=Ch.FindCharacters"Player"local e=e.array[1]
local e=e:FindPluginByName"PadOperator"e.leftStickMappingRate=t
e.rightStickMappingRate=a
end,SetLeftStickMapping=function(e)
local t=Ch.FindCharacters"Player"local t=t.array[1]
local t=t:FindPluginByName"PadOperator"t.leftStickMappingRate=e
end}
