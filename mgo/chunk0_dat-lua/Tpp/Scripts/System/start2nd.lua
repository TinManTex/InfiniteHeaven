...
dofile"/Assets/tpp/sound/scripts/motion/setup.lua"t()
local e=SubtitlesDaemon.GetInstance()
if SubtitlesCommand then
dofile"/Assets/tpp/ui/Subtitles/script/priorityTable.lua"end
t()
dofile"/Assets/tpp/level_asset/chara/player/game_object/TppPlayer2InitializeScript.lua"t()
if Script.LoadLibrary then
Script.LoadLibrary"/Assets/tpp/motherbase/script/MbmCommonSetting.lua"t()
...
Script.LoadLibrary"/Assets/tpp/motherbase/script/MotherBaseWeaponSpecSetting.lua"t()Script.LoadLibrary"/Assets/tpp/motherbase/script/WeaponPartsUiSetting.lua"t()Script.LoadLibrary"/Assets/tpp/motherbase/script/WeaponPartsCombinationSettings.lua"t()
end
if TppSystemUtility.GetCurrentGameMode()=="MGO"then
