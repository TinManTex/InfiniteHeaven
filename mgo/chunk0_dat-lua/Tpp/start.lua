...
if ChVoiceTaskOrganizer2 then
  ChVoiceTaskOrganizer2.PrepareTaskPool("Player",1)ChVoiceTaskOrganizer2.PrepareTaskPool("Enemy",8)
...
if i=="MGO"then
  GrTools:SetLodFactorResolution(1120)
end
...
if TppSystemUtility.GetCurrentGameMode()=="MGO"then
  TppGameSequence.LoadResidentBlock"/Assets/mgo/pack/resident/resident00.fpk"
else
...
if TppSystemUtility.GetCurrentGameMode()~="MGO"then
  ...
  if a=="Xbox360"or a=="PS3"then
    Player.CreateResidentPartsBlock{count=6,size=1126*1024}
  else
    Player.CreateResidentPartsBlock{count=16,size=1536*1024}
  end
...
if TppSystemUtility.GetCurrentGameMode()=="MGO"then
  TppEquip.CreateResidentBlockGroups{commonBlockSize=(10*1024)*1024}
...
if Script.LoadLibrary then
  ...
  WaitFrame()
  local e=o.."level_asset/weapon/ParameterTables/parts/EquipMotionDataForChimera.lua"if TppEquip.IsExistFile(e)then
    Script.LoadLibrary(e)
  end
  ...
  if TppSystemUtility.GetCurrentGameMode()=="MGO"then
    Script.LoadLibrary"/Assets/mgo/ui/Script/BriefingScript.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModCharacterEdit.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModCharacterSelect.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModClassEdit.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModColorNavigation.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModColorPallet.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModControls.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModGearEdit.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModGearOverview.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModGenderEdit.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModInfo.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModLoadoutSelect.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModNavigation_New.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponEditAttach.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponEditPrimary.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponEditSec.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponSubItem.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponSubSkill_New.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/CharacterModWeaponSubSupport.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/LevelUpUi.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/LoadingBgUi.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/MissionResults.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/RoundEnd.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/RoundResult.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/RoundResultStat.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/Ruleset.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/ScoreScript.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/UiAttachmentColors.lua"
    Script.LoadLibrary"/Assets/mgo/ui/Script/UiWeaponAttachmentList.lua"
    Script.LoadLibrary"/Assets/mgo/level_asset/player/ParameterTables/PlayerTables.lua"
    if TppSystemUtility.GetIsBeta()then
      Script.LoadLibrary"/Assets/mgo/level_asset/player/ParameterTables/PlayerProgression_beta.lua"
    else
    ...
    Script.LoadLibrary"/Assets/mgo/level_asset/config/Soundtrack2Config.lua"
    ...
    Script.LoadLibrary"/Assets/mgo/level_asset/config/MgoWeaponParameters.lua"else
    WaitFrame()
  ...
  if i=="MGO"then
    Script.LoadLibraryAsync"/Assets/mgo/script/tpplib/Tpp.lua"while Script.IsLoadingLibrary"/Assets/mgo/script/tpplib/Tpp.lua"
    do
      WaitFrame()
    end
  else
    Script.LoadLibraryAsync"/Assets/tpp/script/lib/Tpp.lua"while Script.IsLoadingLibrary"/Assets/tpp/script/lib/Tpp.lua"
    do
      WaitFrame()
    end
...
if Game.DEBUG_AddScript then
  ...
  if e then
    ...
    local e=e:GetMainGame()e:DEBUG_AddScript(t)Script.LoadLibrary"/Assets/tpp/editor_scripts/tpp_editor_menu2.lua"
...
GrTools.SetLocalLightLodCameraBias(4)
WaitFrame()
do
