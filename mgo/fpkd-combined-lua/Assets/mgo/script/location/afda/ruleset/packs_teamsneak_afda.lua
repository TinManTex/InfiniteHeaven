...
this.GenerateDynamicPackTable = function()
	...
	table.insert( PadTableCandidateA, "pads_01" )
	table.insert( PadTableCandidateA, "pads_03" )
	...
	table.insert( PadTableCandidateB, "pads_02" )
	table.insert( PadTableCandidateB, "pads_04" )
