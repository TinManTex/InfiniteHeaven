...
--search PROJECTTYPE for changes than may need to be done for different projects (tpp vs mgo etc)
...
this.dumpDir=[[D:\Projects\MGS\dumpmgo\]]-- PROJECTTYPE

--DEBUGNOW trying shiz out
function this.PostAllModulesLoad()
  InfCore.Log("IHTearDown.PostAllModulesLoad")
  
  IHGenKnownModuleNames=IHGenKnownModuleNamesMgo--PROJECTTYPE
 ...
 --DEBUGNOW this.RuntimeAnalyzeClasses()
end
...
function this.DumpModules()
  ...
  --open ih_log.txt in an editor that live refreshes to see progress
    local luaFolder=[[J:\GameData\mgo\filetypecrushed\lua\]]--DEBUGNOW PROJECTTYPE
  --local moduleReferences=this.GetModuleReferences(globalsByType.table,luaFolder)
...
function this.GetModuleReferences(modules,luaFolder)
