--DEBUGNOW external test version
InfCore.Log("init_sequence external")--DEBUGNOW
local this = {}
...
local STANDALONE_MODE = TppSystemUtility.GetIsBeta() or true --DEBUGNOW tex added or true
...
function this.StartRulesetMission( locationId, missionCode, rulesetId ) 
  InfCore.Log("------ init_sequence.StartRulesetMission")--DEBUGNOW
...
sequences.Seq_Demo_Start = {
	OnEnter = function(self)
		...
		--DEBUGNOW
    if true then 
      InfCore.Log("init_sequence -------- Seq_Demo_Init")
      TppSequence.SetNextSequence("Seq_Demo_CreateOrLoadSaveData")--"Seq_Demo_Init")
      return
    end
