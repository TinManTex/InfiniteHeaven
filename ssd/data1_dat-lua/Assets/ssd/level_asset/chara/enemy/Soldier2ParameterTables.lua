...
TppSoldier2.ReloadSoldier2ParameterTables{
  sightFormParameter={
    ...
    nightSight={
      discovery={distance=7,verticalAngle=30,horizontalAngle=40},
      indis={distance=15,verticalAngle=60,horizontalAngle=60},
      dim={distance=40,verticalAngle=60,horizontalAngle=60},
      far={distance=41,verticalAngle=0,horizontalAngle=0}
    },
    combatSight={
    ...
    foggySight={distanceRate=.8,angleRate=.6}
  },
  ...
  lifeParameterTable={maxLife=2600,maxStamina=3e3,maxLimbLife=300,maxArmorLife=7500,maxHelmetLife=500,sleepRecoverSec=300,faintRecoverSec=50,dyingSec=60},
