...
local l={
  ...
  [Fox.StrCode32"PlayerCraftingHead"]={locName="SSD_Camera_Player_Crafting_Head",distance=1.95,interpTime=.3,lock=false,minX=-5,maxX=5,rotateY=false,attachBone=4,aperture=1,focusDistance=1},
  [Fox.StrCode32"PlayerCraftingChest"]={locName="SSD_Camera_Player_Crafting_Chest",distance=2.1,interpTime=.3,lock=false,minX=-5,maxX=5,rotateY=false,attachBone=2,aperture=1,focusDistance=1.5},
  [Fox.StrCode32"PlayerCraftingArm"]={locName="SSD_Camera_Player_Crafting_Arm",distance=2,interpTime=.3,lock=false,minX=-5,maxX=5,rotateY=false,attachBone=11,aperture=1,focusDistance=1.6},
  [Fox.StrCode32"PlayerCraftingLeg"]={locName="SSD_Camera_Player_Crafting_Leg",distance=2.3,interpTime=.3,lock=false,minX=0,maxX=5,rotateY=false,attachBone=0,aperture=1,focusDistance=2},
  ...
  [Fox.StrCode32"PlayerWarehouseCommon"]={locName="SSD_Camera_Player_Warehouse_Common",distance=2.75,interpTime=.3,lock=false,minX=-5,maxX=5,rotateY=false,attachBone=0,aperture=1,focusDistance=2.75},
  [Fox.StrCode32"FacilityCommon"]={locName="SSD_Camera_Facility_Common",distance=2,interpTime=0,lock=false,minX=-90,maxX=90,rotateY=false,attachBone=0,aperture=1,focusDistance=2},
