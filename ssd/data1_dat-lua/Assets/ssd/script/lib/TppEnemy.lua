...
function this.Messages()
  return Tpp.StrCode32Table{GameObject={{msg="Dead",func=this._OnDead},{msg="Damage",func=this._OnDamage},{msg="RoutePoint2",func=this._DoRoutePointMessage},{msg="ChangePhaseForAnnounce",func=this._AnnouncePhaseChange},{msg="NpcActivated",func=this._OnNpcActivated,option={isExecDemoPlaying=true,isExecMissionPrepare=true,isExecFastTravel=true,isExecMissionClear=true,isExecGameOver=true}}},Weather={{msg="Clock",sender="ShiftChangeAtNight",func=function(n,n)
    this.ShiftChangeByTime"shiftAtNight"end},{msg="Clock",sender="ShiftChangeAtMorning",func=function(n,n)
    this.ShiftChangeByTime"shiftAtMorning"end},{msg="Clock",sender="ShiftChangeAtMidNight",func=function(n,n)
      this.ShiftChangeByTime"shiftAtMidNight"end}}}
end
...
function this.SetExcludeHostage(e)
  mvars.ene_excludeHostageGameObjectId=o(e)
end
...
function this.GetAllActiveEnemyWalkerGear()
  ...
  local r=0
  while r<e do
    local n=_("TppCommonWalkerGear2",r)
    if n==a then
      break
    end
    if e==1 then
    ...
    local a=t(n,{id="IsBroken"})
    local e=t(n,{id="IsFultonCaptured"})
...
function this.SetSneakRoute(e,o,n,r)
  ...
  if e~=a then
    t(e,{id="SetSneakRoute",route=o,point=n,isRelaxed=i})
  end
end
...
function this.SetCautionRoute(e,r,n,i)
  ...
  n=n or 0
  if e~=a then
    t(e,{id="SetCautionRoute",route=r,point=n})
  end
end
...
function this.SetAlertRoute(e,r,n,i)
  ...
  n=n or 0
  if e~=a then
    t(e,{id="SetAlertRoute",enabled=true,route=r,point=n})
  end
end
...
function this.RegistRoutePointMessage(e)
  ...
  local n={}n[r"GameObject"]=Tpp.StrCode32Table(e.messages)
  local n=(Tpp.MakeMessageExecTable(n))[r"GameObject"]
...
function this.InitialRouteSetGroup(e)
  ...
  t(r,{id="AssignSneakRouteGroup",soldiers=n,group=i})
end
...
function this.NoShifhtChangeGruopSetting(e,n)
  ...
  mvars.ene_noShiftChangeGroupSetting[e][r(n)]=true
end
...
function this.RegisterSoldier2CommonMotionPackagePath(n)
  ...
  if t then
    if l(n)then
      gvars.ene_soldier2CommonPackageLabelIndex=r(n)
    else
...
function this.IsRequiredToLoadSpecialSolider2CommonBlock()
  if r(mvars.ene_soldier2CommonBlockPackageLabel)~=TppDefine.DEFAULT_SOLIDER2_COMMON_PACKAGE then
    return true
  else
    return false
  end
...
function this.IsRequiredToLoadDefaultSoldier2CommonPackage()
  local e=r(mvars.ene_soldier2CommonBlockPackageLabel)
...
this.STR32_CAN_USE_SEARCH_LIGHT=r"CanUseSearchLight"this.STR32_CAN_NOT_USE_SEARCH_LIGHT=r"CanNotUseSearchLight"this.STR32_IS_GIMMICK_BROKEN=r"IsGimmickBroken"this.STR32_IS_NOT_GIMMICK_BROKEN=r"IsNotGimmickBroken"function this.SetUpSwitchRouteFunc()
end
...
function this.SetUpCommandPost()
  ...
  for n,a in pairs(mvars.ene_cpList)do
    t(n,{id="SetRouteSelector",func=this.RouteSelector})
  end
end
...
function this.MergeRouteSetDefine(i)
  ...
  for e,n in pairs(i)do
    ...
    if n.walkergearpark then
      local e=o(e)t(e,{id="SetWalkerGearParkRoute",routes=n.walkergearpark})
    end
  ...
  for n,t in pairs(n)do
    ...
    if n==a then
      ...
      if t.priority then
        ...
        for e=1,#(t.priority)do
          mvars.ene_routeSetsPriority[n][e]=r(t.priority[e])
        end
      end
      if t.fixedShiftChangeGroup then
        for e=1,#(t.fixedShiftChangeGroup)do
      ...
      for a,e in pairs(this.ROUTE_SET_TYPES)do
        ...
        if t[e]then
          for t,a in pairs(t[e])do
            mvars.ene_routeSets[n][e][r(t)]=mvars.ene_routeSets[n][e][r(t)]or{}
...
function this.DisableUseGimmickRouteOnShiftChange(a,e)
  ...
  for n,e in pairs(e)do
    ...
    local n=mvars.gim_routeGimmickConnectTable[r(e)]
...
function this._AddTakingOverHostage(n)
  ...
  local i,r=t(n,{id="GetStaffId",divided=true})
  local o=t(n,{id="GetFaceId"})
...
function this._SpawnTakingOverHostage(n,e)
  ...
  if n<gvars.ene_takingOverHostageCount then
    ...
    local r=gvars.ene_takingOverHostageStaffIdsLower[infoIndex]t(e,{id="SetStaffId",divided=true,staffId=a,staffId2=r})
    if TppMission.IsMissionStart()then
      t(e,{id="SetEnabled",enabled=true})
      local a=Vector3(gvars.ene_takingOverHostagePositions[n*3],gvars.ene_takingOverHostagePositions[n*3+1],gvars.ene_takingOverHostagePositions[n*3+2])t(e,{id="Warp",position=a})t(e,{id="SetFaceId",faceId=gvars.ene_takingOverHostageFaceIds[n]})t(e,{id="SetKeepFlagValue",keepFlagValue=gvars.ene_takingOverHostageFlags[n]})
    end
  else
...
function this.SetIgnoreDisableNpc(n,r)
  ...
  t(e,{id="SetIgnoreDisableNpc",enable=r})
  return true
end
...
function this._OnDamage(a,t,n)
  if this.IsRescueTarget(a)then
    this._OnDamageOfRescueTarget(t,n)
  end
end
...
function this.KillWaveEnemy(n)Mission.DiggerShockWave{type=TppDefine.DIGGER_SHOCK_WAVE_TYPE.FINISH_WAVE}
...
function this._OnNpcActivated(n,e)
  ...
  if not TppMission.IsCoopMission(a)then
    if(e==Fox.StrCode32"Gluttony")or(e==Fox.StrCode32"Aerial")then
      if mvars.loc_stealthAreaNameTable then
        local e=mvars.loc_stealthAreaNameTable[e]
        if e then
          t(n,{id="SetStealthArea",name=e})
        end
      end
      if mvars.loc_aerialRouteTable then
        t(n,{id="SetHuntDownRoute",routes=mvars.loc_aerialRouteTable})
      end
    end
  end
end
function this.SetZombieSneakRoute(a,n,r,e,i)
  ...
  e=e or 0
  n=n or"SsdZombie"t({type=n},{id="SetSneakRoute",name=a,route=r,point=e})
end
function this.SetBreakBody(o,a,n,e,i,r)
  ...
  i=i or 0
  r=r or 0
  t({type=a},{id="SetBreakBody",locatorName=o,armR=n,armL=e,legR=i,legL=r})
end
function this.SetZombieWaveWalkSpeed(n,e,t)
  if not Tpp.IsTypeString(n)then
    return
  end
  e=e or"SsdZombie"GameObject.SendCommand({type=e},{id="SetWaveWalkSpeed",speed=t,locatorName=n})
end
...
function this.SetInsectSneakRoute(t,e,r,n,i)
  ...
  n=n or 0
  e=e or"SsdInsect1"local e=GameObject.GetGameObjectId(e,t)
  if(e==a)then
    return
  end
...
function this.SetEnablePermanent(n,e)
  ...
  e=e or"SsdZombie"GameObject.SendCommand({type=e},{id="SetEnabledWithLocator",name=n,enabled=true,permanent=false})
end
function this.SetDisablePermanent(n,e)
  if not Tpp.IsTypeString(n)then
    return
  end
  e=e or"SsdZombie"GameObject.SendCommand({type=e},{id="SetEnabledWithLocator",name=n,enabled=false,permanent=true})
end
