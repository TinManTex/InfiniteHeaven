...
this.GAME_OVER_RADIO_LIST={{radioGroup="f3000_rtrg3010",condition=function()
  return(TppStory.GetCurrentStorySequence()<=TppDefine.STORY_SEQUENCE.CLEARED_TUTORIAL)
end},{radioGroup={"f3000_rtrg3020","f3000_rtrg3021"},condition=function()
...
end},{radioGroup="f3000_rtrg3030",condition=function()
