...
function e.IsPlayingSceneBGM(e)
if(svars.snd_bgmNameHash==s(e))then
return true
else
return false
end
...
mvars.snd_bgmList={}
mvars.snd_bgmList.bgm_title={start="Play_SSD_BGM_sys_stup"}
end
...
function e.OnMessage(t,r,a,l,s,i,n)
Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,t,r,a,l,s,i,n)
end
