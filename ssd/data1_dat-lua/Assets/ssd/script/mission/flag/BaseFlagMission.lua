...
local a="p01_000010"local C="_isPlayedEnterMissionAreaRadio"e.CLEAR_JINGLE_TYPE=Tpp.Enum{"CRAFT","BATTLE","NONE"}
e.CLEAR_JINGLE_NAME=Tpp.Enum{"Play_SSD_Jingle_msn_comp_lt","Play_SSD_Jingle_msn_comp_hd",""}
...
e.baseStep={OnEnter=function(a)
local s=mvars.currentFlagMissionName
local r=a.stepName
...
local o=i.demo
if o then
local n,t,a=e.GetDemoParameter(o,a.demoOnEndFunctionTable)
if n then
e.LoadRegisteredMissionDemoBlock()
TppDemo.AddDemo(n,n)
TppDemo.Play(n,a,t)
end
end
...
local o=i.kill
if n(o)then
local n,t,r,i,o=e.GetStepAnnihilationParams(r)
if n then
...
if n(o)then
local n=tostring(s)..("_"..(tostring(r).."_completeCraft"))
mvars.bfm_checkCraftStepCoroutine=e.CreateCheckCraftStepCoroutine(o,n)
end
local o=i.collect
if n(o)then
...
local r=e.getSwitchConditionVarsName(s,r,a)
...
e.OnStartClearSequence(n)
end
end
e.RestoreCheckRegisteredStepMissionObjective(a.stepMissionObjectiveTable)
...
local o=i.kill
if n(o)then
local t,i,n,a,i=e.GetStepAnnihilationParams(a.stepName)
if t then
e.FinalizeStepAnnihilationTarget(n,a)
if DebugText then
...
function e.AddSaveVarsList(e,a)
...
function e.RegisterStepMissionObjective(i,a,e)
if not n(e)then
return
end
...
function e.RestoreCheckRegisteredStepMissionObjective(n)
...
function e.CheckRegisteredStepMissionObjective(a,n)
if not n then
return
end
local a=a[n]
...
function e.OnStartClearSequence(a)
...
mvars.bfm_clearSequenceCoroutine=coroutine.create(e.ClearSequenceCoroutine)
mvars.bfm_finishedClearSequence=true
end
function e.ClearSequenceCoroutine()
local function t(e)
if DebugText then
...
n,a,o=e.GetDemoParameter(mvars.bfm_clearStageTable.demo,t)
end
if n then
e.LoadRegisteredMissionDemoBlock()
if not i then
...
function e.OnClearSequenceFinished()
mvars.bfm_clearSequenceCoroutine=nil
mvars.bfm_clearStageTable=nil
Player.ResetPadMask{settingName="OnFlagMissionClear"}SsdBuildingMenuSystem.CloseBuildingMenu()SsdUiSystem.RequestForceCloseForMissionClear()SsdFlagMission.ClearWithSave(TppDefine.FLAG_MISSION_CLEAR_TYPE.CLEAR,mvars.currentFlagMissionName)
mvars.currentFlagMissionName=nil
end
function e.CheckObjective(e)
if t(e)then
e={e}
end
if n(e)then
...
function e.GetNameFromStringOrTable(e)
if t(e)then
return e
end
...
function e.GetLocatorName(e)
if n(e)and t(e.locatorName)then
return e.locatorName
end
end
function e.getSwitchConditionVarsName(a,n,t)
return tostring(a)..("_"..(tostring(n)..("_switch_"..tostring(t))))
end
e.NEED_SET_DEMOTRANSFORM={p01_000030=true}
function e.GetDemoParameter(a,r)
...
i=s(o,r)
local e=e.NEED_SET_DEMOTRANSFORM[o]
if i then
if n(a.funcs)then
if e then
...
return e.AddStep(i,t,o,r,n)
end
function e.AddStep(o,a,b,r,m)
if not n(o)then
return
end
...
local d=r.demo
if d then
local t=e.GetDemoParameter(d)
if t then
local n=tostring(s)..("_"..(tostring(a)..("_demo_"..tostring(t))))
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
...
e.RegisterStepMissionObjective(p,n,d)
end
local d=r.trap
if t(d)or n(d)then
local n,i
...
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
e.AddMessage(f,{Trap={{sender=i,msg="Enter",func=function(a,e)
...
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
e.AddMessage(f,{Trap={{sender=i,msg="Exit",func=function(a,e)
if Tpp.IsPlayer(e)then
fvars[n]=true
l:GoToNextStepIfConditionCleared(n)
end
...
local i,t=e.InitializeStepAnnihilationTable(a,d,n)
if i then
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_UINT32,value=t,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
e.AddMessage(f,{GameObject={{msg="Dead",func=function(t)
e.OnDeadCheckMissionTargetAnnihilation(t,l,a,mvars.defenseFlagMission,n)
end}}})
end
end
local d=r.putDigger
...
e.AddSaveVarsList(o,{{name=a,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,a)
e.RegisterStepMissionObjective(p,a,d)d.conditionVarsName=a
...
e.AddMessage(f,{GameObject={{msg="BuildingEnd",func=t,option={isExecFastTravel=true}}}})
end
local d=r.switch
if n(d)then
local function r(i)
...
local n=e.getSwitchConditionVarsName(s,a,n)
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
e.RegisterStepMissionObjective(p,n,i)
end
...
local function i(n)
local e=e.getSwitchConditionVarsName(s,a,n.locatorName)r(n)fvars[e]=true
...
r(a)o(a,false)
e.PlayGetMemoryBoardDemo(n,s,n.afterDemoFunc)
end
e.AddMessage(f,{GameObject={{msg="SwitchGimmick",func=s}},UI={{msg="EndFadeOut",sender="OnSwitchGimmickMemoryBoardDemoFadeOut",func=l}},Demo={{msg="p01_000040_gameModelOn",func=function()
local e=t
if not n(e)then
return
end
...
e.AddSaveVarsList(o,{{name=t,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,t)
e.RegisterStepMissionObjective(p,t,r.wave)
...
e.AddMessage(f,{GameObject={{msg="FinishWave",func=d},{msg="StartRebootDigger",func=l},{msg="DiggingStartEffectEnd",func=i},{msg="FinishDefenseGame",func=o},{msg="DiggerShootEffect",func=function()GkEventTimerManager.Start("Timer_DestroySingularityEffect",.9)
...
local n=e.GetLocatorName(t)
table.insert(i,n)
local n=tostring(s)..("_"..(tostring(a)..("_carry_"..tostring(n))))
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
e.RegisterStepMissionObjective(p,n,t)
end
e.AddMessage(f,{GameObject={{msg="Carried",func=function(n,t)
for i,t in ipairs(d)do
local e=e.GetLocatorName(t)
...
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
mvars.bfm_clearJingleType=e.CLEAR_JINGLE_TYPE.CRAFT
end
local d=r.collect
if n(d)then
local n=function(e)
...
table.insert(c,n)
e.RegisterStepMissionObjective(p,n,t)t.conditionVarsName=n
end
local n=function()
local a=false
...
e.AddMessage(f,{Sbm={{msg="OnGetItem",func=n}}})
mvars.bfm_clearJingleType=e.CLEAR_JINGLE_TYPE.CRAFT
end
local t=r.blackRadio
if t then
i=e.CheckBlackRadioParameter(t)
if i then
local n=tostring(s)..("_"..(tostring(a).."_blackRadio"))
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(c,n)
e.RegisterStepMissionObjective(p,n,t)i.conditionVarsName=n
...
e.AddMessage(f,{UI={{msg="EndFadeOut",sender="StartBlackRadioFadeOut",func=function()
...
e.PlayRadio(i.startRadio)
if GkEventTimerManager.IsTimerActive(n)then
GkEventTimerManager.Stop(n)
end
GkEventTimerManager.Start(n,i.startGuaranteeTimerSec)i.isPlayedStartRadio=true
end
e.AddMessage(f,{Radio={{msg="Finish",sender=i.startRadio,func=function(e)i.StartBlackRadioFadeOut()
...
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(T,n)
e.AddMessage(f,{Trap={{sender=i,msg="Enter",func=function()
if not fvars[n]then
local a=r.radio
if a then
TppRadio.Play(a)
...
e.AddSaveVarsList(o,{{name=n,type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
table.insert(h,n)
e.AddMessage(f,{[r]={{sender=i,msg=t,func=function()
if not fvars[n]then
fvars[n]=true
l:GoToNextStepIfConditionCleared(n)
end
...
e.AddMessage(f,{GameObject={{msg="DiggingStartEffectEnd",func=a}},Timer={{msg="Finish",sender="Timer_OpenRewardWhormhole",func=n}}})
end
...
e.CheckRegisteredStepMissionObjective(a.stepMissionObjectiveTable,s)
local i,o=e.CheckStepClearCondition(r.orCheck,a.conditionVarsNameList)
if a.options then
local n=a.options
if i and n.checkObjectiveIfCleared then
e.CheckObjective(a.options.checkObjectiveIfCleared)
end
...
if n then
e.RevertStepOnOutOfDefenseArea(o,n)
end
end
end
e.OnUpdateCheckCraftStepCoroutine(l)
e.OnUpdateClearSequenceCoroutine()
...
a.commonMessageTable={}a.commonMessageTable=e.AddMessage(a.commonMessageTable,{Timer={{msg="Finish",sender="Timer_CloseRewardWhormhole",func=function()
...
e.InitializePutDiggerVisibility(n.clearConditionTable.putDigger)
end
end
local n=a.showDiggerPlanedPlace
if n then
e.ShowDiggerPlanedPlace(a,n)
end
...
mvars.ply_unexecFastTravelByMenu=false
mvars.fms_waveSettings=nil
e.FinalizeStepAnnihilationTable()BaseMissionSequence.EnableBaseCheckPoint()BaseMissionSequence.UnregisterEnterBaseCheckPointCallback()
...
e.RevertStepOnOutOfDefenseArea(a,n)
else
...
e.AddSaveVarsList(a,{{name=tostring((i)..C),type=TppScriptVars.TYPE_BOOL,value=false,save=true,category=TppScriptVars.CATEGORY_MISSION}})
end
if a.saveVarsList then
SsdFlagMission.DeclareFVars(a.saveVarsList)
end
if a.registerRescueTargetUniqueCrew then
local n=e.RegisterRescueTargetUniqueCrew(a.registerRescueTargetUniqueCrew)
if n then
a.commonMessageTable=e.AddMessage(a.commonMessageTable,{GameObject={{msg="Dead",func=function(e)
...
e.ClearDiggerPlanedPlace(a,a.showDiggerPlanedPlace)
end
...
a.commonMessageTable=e.AddMessage(a.commonMessageTable,n)
end
...
if a.enterMissionAreaRadio then
e.PlayEnterMissionAreaRadio(i,a.enterMissionAreaRadio)
end
...
function e.InitializePutDiggerVisibility(e)
...
function e.ShowDiggerPlanedPlace(e,n)
...
function e.ClearDiggerPlanedPlace(e,n)
if not e.importantGimmickList then
return
end
local e=e.importantGimmickList[n]
...
function e.PlayGetMemoryBoardDemo(e,n,a)
...
function e.LoadRegisteredMissionDemoBlock()
local n=mvars.fms_missionmissionDemoBlock
if n then
e.LoadMissionDemoBlock(n)
end
end
function e.LoadMissionDemoBlock(e)
if not n(e)then
return
end
...
function e.CheckStepClearCondition(i,n)
local t=0
local e
if i then
e=false
...
function e.RegisterRescueTargetUniqueCrew(e)
if not n(e)then
return
end
local n=e.locatorName
...
function e.InitializeStepAnnihilationTable(i,e,o)
if not t(o)then
return
end
...
function e.OnDeadCheckMissionTargetAnnihilation(r,s,n,o,a)
local i,n,t,a=e.GetStepAnnihilationParams(n)
if not i then
return
end
if e.IsAnnihilationTarget(r,t,a)then
e.DecrimentAnnihilationRemainCount(n)
if o then
...
function e.IsAnnihilationTarget(a,n,e)
for e=1,e do
local e=n[e]
local e=S(e)
if(e==a)then
...
function e.InitializeStepAnnihilationTarget(r,o,n,a)
local i={id="GetLifeStatus"}
local t=e.SetMissionTarget
for n=1,n do
local n=o[n]
local a=a[n]or a[1]
local n=t(n,true,a)
...
e.DecrimentAnnihilationRemainCount(r)
end
end
end
end
function e.SetUpWaveSettings()
...
function e.FinalizeStepAnnihilationTarget(n,a)
local e=e.SetMissionTarget
for a=1,a do
local n=n[a]e(n,false)
end
end
function e.FinalizeStepAnnihilationTable()
mvars.bfm_annihilationTable=nil
mvars.bfm_DEBUG_stepAnnihilationTable=nil
end
function e.DecrimentAnnihilationRemainCount(e)
if fvars[e]>0 then
fvars[e]=fvars[e]-1
end
end
function e.GetStepAnnihilationParams(e)
...
function e.SetMissionTarget(e,t,n)
local e=S(e)
if(e==h)then
return
end
...
function e.CreateCheckCraftStepCoroutine(n,a)
...
return coroutine.create(e.CheckCraftStepCoroutine)
end
function e.DestroyCheckCraftStepCoroutine()
...
function e.OnUpdateCheckCraftStepCoroutine(n)
...
if not a then
e.DestroyCheckCraftStepCoroutine()
return
end
...
function e.CheckCraftStepCoroutine()
local o=SsdBuilding.GetItemCount
local i={facility="hoge"}
local r={id="hoge"}
local c=SsdSbm.GetCountProduction
local s={id="PRD_*",inInventory=true,inWarehouse=true}
local p=MissionObjectiveInfoSystem.SetTable
...
t=n
coroutine.yield()until(t>=l)
e.CheckObjective(f)
return true
end
function e.PlayEnterMissionAreaRadio(n,a)
...
function e.GetCollectionCount(n)
...
function e.IsClearCollectCondition(n)
local a=n.count
if not u(a)then
return
end
local n=e.GetNameFromStringOrTable(n)
if not n then
return
end
local e=e.GetCollectionCount(n)
if not e then
return
end
if e>=a then
...
function e.CheckBlackRadioParameter(e)
local i,a,o
if t(e)then
a={e}
elseif n(e)then
...
function e.RevertStepOnOutOfDefenseArea(a,n)
local e=TppMission.GetWaveProperty(n)
if e==nil then
return
end
