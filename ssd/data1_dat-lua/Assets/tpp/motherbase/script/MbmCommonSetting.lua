...
local e={{lv=1,lineSectionPoint=43},
...
TppMotherBaseManagement.SortSkillDrawingParamTable()TppMotherBaseManagement.RegisterQuestSkillDrawingParam{skill="Reflex",section="Combat",rank="C",priority=98,rate=20,staffTypes={2,39,40,41,47},randomRangeIds={2,3}}
