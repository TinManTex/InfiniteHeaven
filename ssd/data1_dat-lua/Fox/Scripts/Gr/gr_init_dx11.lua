GrTools:EnableTextureStreaming()GrTools:SetTexturePackLoadConditioningEnable(true)
GrTools.SetDefaultTextureLoadPath"tmp/"
GrTools.SetReflectionTexture"/Assets/fox/effect/gr_pic/default_reflection.ftex"
GrTools.SetMaterialTexture"/Assets/ssd/effect/gr_pic/materials_alp_rgba32_nomip_nrt.ftex"
GrTools.SetMaterialParamBinary"/Assets/ssd/effect/gr_pic/material_params.fmtt"
...
if not AssetConfiguration.IsDiscOrHddImage()then
  e=AssetConfiguration.GetConfigurationFromAssetManager"EnableWindowsDX11Texture"end
...
GrRenderPlugin.AddPlugin(GrPluginTonemap{pluginName="TONEMAP",priority=910})
GrRenderPlugin.AddPlugin(GrPluginFxaa{pluginName="FXAA",priority=920,isActive=false})
...
GrRenderPlugin.AddPlugin(GrPluginContactShadow{pluginName="CONTACT_SHADOW",priority=32,parentPluginName="SHADING_PASS"})
GrRenderPlugin.AddPlugin(GrPluginRaymarchingFog{pluginName="RAYMARCHING_FOG",priority=35,parentPluginName="SHADING_PASS"})
