  ...
  GrGraphicsSettingManager.SetPluginSettingSelection{
    allSettings={
      ...
      {settingName="PluginModel",settingTable={
        ...
        {name="Low",RejectionLengthBias=16},
        {name="Medium",RejectionLengthBias=24},
      ...
      {settingName="PluginClone",settingTable={
        ...
        {name="Low",RejectionLengthBias=32},
        {name="Medium",RejectionLengthBias=48},
      ...
      {settingName="PluginSsao",settingTable={
        {name="G7",EnableFilter=1,EnableBilateralUpscale=0},
        {name="G8E",EnableFilter=1,EnableBilateralUpscale=0},
        {name="Default",EnableFilter=1,EnableBilateralUpscale=0},
        {name="Off",EnableFilter=0,EnableBilateralUpscale=0},
        {name="Low",EnableFilter=0,EnableBilateralUpscale=0},
        {name="High",EnableFilter=1,EnableBilateralUpscale=1},
        {name="ExtraHigh",EnableFilter=1,EnableBilateralUpscale=1}}},
      ...
      {settingName="PluginGlobalVolumetricFog",settingTable={
        {name="G7",VolumeWidth=120,VolumeHeight=64,VolumeDepth=128,LayersPerRow=32},
        {name="G8E",VolumeWidth=120,VolumeHeight=64,VolumeDepth=128,LayersPerRow=32},
        {name="Default",VolumeWidth=120,VolumeHeight=64,VolumeDepth=128,LayersPerRow=32},
        {name="Low",VolumeWidth=120,VolumeHeight=64,VolumeDepth=128,LayersPerRow=32},
        {name="High",VolumeWidth=120,VolumeHeight=64,VolumeDepth=128,LayersPerRow=32},
        {name="ExtraHigh",VolumeWidth=240,VolumeHeight=128,VolumeDepth=256,LayersPerRow=32}}}}}
end
