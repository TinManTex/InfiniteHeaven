TppPadOperatorUtility={
  ...
  SetStickMapping=function(leftStickMappingRate,rightStickMappingRate)
    local player=Ch.FindCharacters"Player"
    local e=player.array[1]
    local padOperator=e:FindPluginByName"PadOperator"
    padOperator.leftStickMappingRate=leftStickMappingRate
    padOperator.rightStickMappingRate=rightStickMappingRate
  end,
  SetLeftStickMapping=function(leftStickMappingRate)
    local player=Ch.FindCharacters"Player"
    local t=player.array[1]
    local padOperator=t:FindPluginByName"PadOperator"
    padOperator.leftStickMappingRate=leftStickMappingRate
  end
}
