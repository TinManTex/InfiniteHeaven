...
function this.CreateInstance(e)
  local instance={}
  function instance.GetSpawnLocatorNames(a)
    local n=instance.waveSettingTable
    if Tpp.IsTypeTable(n)then
      ...
      while n do
        ...
        if a then
          local a=instance.spawnSettingTable[a]
          if Tpp.IsTypeTable(a)then
            ...
            if Tpp.IsTypeTable(a)then
              ...
              if a then
                ...
                n=instance.waveSettingTable[n.nextWave]
              else
                n=nil
              end
            else
  ...
  function instance.GetSpawnRouteNameTable(a)
    local n=instance.waveSettingTable
    if Tpp.IsTypeTable(n)then
      local t={}
      local n=n[a]
  ...
  function instance.SetUpEnemy()
    ...
    local n=instance.spawnSettingTable
    if Tpp.IsTypeTable(n)then
    ...
    Mission.RegisterEnemyLaneRouteTable(instance.mapRouteNameListTable)
    local n=instance.routeSettingTableList
    if Tpp.IsTypeTable(n)then
    ...
    local n=instance.enemyLevelSettingTable
    if Tpp.IsTypeTable(n)then
