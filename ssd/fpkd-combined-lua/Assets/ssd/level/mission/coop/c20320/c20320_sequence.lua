...
local this = BaseCoopMissionSequence.CreateInstance( "c20320" )

this.MISSION_START_INITIAL_ACTION = PlayerInitialAction.SQUAT
this.MISSION_WORLD_CENTER = Vector3( -632.475, 342.623, 461.812 )	
...
this.targetGimmickTable = {
	...
	datasetName = "/Assets/ssd/level/location/afgh/block_mission/large/enemyBase/afgh_enemyBase_digger_c01.fox2",
...
this.craftGimmickTableTable = {
	[ Fox.StrCode32( "PRD_BLD_WeaponPlant_A" ) ] = {	
		...
		datasetName = "/Assets/ssd/level/location/afgh/block_mission/large/enemyBase/afgh_enemyBase_plant_c01.fox2",
		type = TppGameObject.GAME_OBJECT_TYPE_IMPORTANT_BREAKABLE,
		visible = true,
	},
...
this.importantGimmickTableList = {
	{ locatorName = "whm0_gim_n0000|srt_whm0_main0_def_v00", datasetName = "/Assets/ssd/level/location/afgh/block_mission/large/enemyBase/afgh_enemyBase_digger_c01.fox2", },
}
...
this.defenseGameDataJsonFilePath = "/Assets/ssd/level_asset/defense_game/enemyBase/c20320.json"
