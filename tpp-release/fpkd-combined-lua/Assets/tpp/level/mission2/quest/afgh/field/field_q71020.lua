...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 420.998, cpPosition_y = 269.890, cpPosition_z = -2216.564, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 420.998, cpPosition_y = 269.890, cpPosition_z = -2216.564, gtPosition_r = 50.0,
		},
	},
