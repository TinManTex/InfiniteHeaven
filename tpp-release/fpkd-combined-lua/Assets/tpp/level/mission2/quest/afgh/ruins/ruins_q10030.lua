...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1312.023, cpPosition_y = 324.181, cpPosition_z = 1740.218, cpPosition_r = 80.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1312.023, gtPosition_y = 324.181, gtPosition_z = 1740.218, gtPosition_r = 10.0,
		},
	},
