...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1426.164, cpPosition_y = 319.449, cpPosition_z = 1053.029, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1426.164, gtPosition_y = 319.449, gtPosition_z = 1053.029, gtPosition_r = 50.0,
		},
	},
...
quest_step.QStep_Start = {
	OnEnter = function()
		...
		TppUiCommand.RegisterIconUniqueInformation{ markerId = GameObject.GetGameObjectId("sol_quest_0001"), langId = "marker_ene_elite" }
