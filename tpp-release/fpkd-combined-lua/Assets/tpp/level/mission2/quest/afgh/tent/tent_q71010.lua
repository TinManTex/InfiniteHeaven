...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1759.032, cpPosition_y = 310.695, cpPosition_z = 806.245, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1759.032, cpPosition_y = 310.695, cpPosition_z = 806.245, gtPosition_r = 50.0,
		},
	},
