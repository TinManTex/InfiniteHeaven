...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1491.786, cpPosition_y = 395.982, cpPosition_z = -791.811, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1491.786, cpPosition_y = 395.982, cpPosition_z = -791.811, gtPosition_r = 50.0,
		},
	},
