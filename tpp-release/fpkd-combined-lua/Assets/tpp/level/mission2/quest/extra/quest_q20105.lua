...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -314.563, cpPosition_y = -17.844, cpPosition_z = 1106.167, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -314.563, cpPosition_y = -17.844, cpPosition_z = 1106.167, cpPosition_r = 70.0,
		},
	},
	...
	Messages = function( self )
		...
		StrCode32Table {
			Trap = {
				...
				{
					msg = "Enter",	sender = "trap_HostageScaredOff",
					func = function ()
