...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 600.070, cpPosition_y = 56.417, cpPosition_z = -964.705, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 600.070, cpPosition_y = 56.417, cpPosition_z = -964.705, cpPosition_r = 70.0,
		},
	},
