...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1550.690, cpPosition_y = 121.650, cpPosition_z = -1217.538, cpPosition_r = 100.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1550.690, cpPosition_y = 121.650, cpPosition_z = -1217.538, cpPosition_r = 100.0,
		},
	},
	...
	enemyList = {
		{
			...
			route_d = "rt_diamondRiver_d_0000", 	route_c = "rt_diamondRiver_c_0000",
			powerSetting = { "SNIPER", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0001",
			route_d = "rt_diamondRiver_d_0001", 	route_c = "rt_diamondRiver_c_0001",
			powerSetting = { "SOFT_ARMOR", "HELMET", "MG", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0002",
			route_d = "rt_diamondRiver_d_0002", 	route_c = "rt_diamondRiver_c_0002",
			powerSetting = { "SOFT_ARMOR", "HELMET", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0003",
			route_d = "rt_diamondRiver_d_0003", 	route_c = "rt_diamondRiver_c_0003",
			powerSetting = { "SOFT_ARMOR", "HELMET", "MG", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0004",
			route_d = "rt_diamondRiver_d_0004", 	route_c = "rt_diamondRiver_c_0003",
			powerSetting = { "SOFT_ARMOR", "HELMET", "MISSILE", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0005",
			route_d = "rt_diamondRiver_d_0005", 	route_c = "rt_diamondRiver_c_0005",
			powerSetting = { "SOFT_ARMOR", "HELMET", "SHOTGUN", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0006",
			route_d = "rt_diamondRiver_d_0006", 	route_c = "rt_diamondRiver_c_0006",
			powerSetting = { "SHIELD", "SMG", },
			soldierSubType = "PF_C",
		},
		{
			enemyName = "sol_quest_0007",
			route_d = "rt_diamondRiver_d_0002", 	route_c = "rt_diamondRiver_c_0001",
			powerSetting = { "SHIELD", "SMG", },
			soldierSubType = "PF_C",
		},
	},
