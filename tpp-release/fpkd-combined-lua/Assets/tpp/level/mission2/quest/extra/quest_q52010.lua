...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1388.719, cpPosition_y = 299.004, cpPosition_z = 1976.527, cpPosition_r = 30.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1388.719, gtPosition_y = 299.004, gtPosition_z = 1976.527, gtPosition_r = 30.0,
		},
	},
