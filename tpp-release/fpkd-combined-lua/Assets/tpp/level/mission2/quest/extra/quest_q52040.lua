...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1589.128, cpPosition_y = 511.561, cpPosition_z = -2113.037, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1589.128, gtPosition_y = 511.561, gtPosition_z = -2113.037, gtPosition_r = 50.0,
		},
	},
