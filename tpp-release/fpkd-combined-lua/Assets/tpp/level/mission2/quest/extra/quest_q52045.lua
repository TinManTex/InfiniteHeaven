...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1678.340, cpPosition_y = 143.678, cpPosition_z = -2064.915, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1678.340, gtPosition_y = 143.678, gtPosition_z = -2064.915, gtPosition_r = 70.0,
		},
	},
