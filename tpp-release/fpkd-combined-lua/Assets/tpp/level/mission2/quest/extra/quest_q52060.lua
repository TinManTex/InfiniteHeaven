...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1156.773, cpPosition_y = -12.097, cpPosition_z = 1524.507, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1156.773, gtPosition_y = -12.097, gtPosition_z = 1524.507, gtPosition_r = 70.0,
		},
	},
