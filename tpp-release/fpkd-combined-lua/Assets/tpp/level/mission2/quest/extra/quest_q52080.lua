...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 857.481, cpPosition_y = 342.146, cpPosition_z = 226.561, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 857.481, cpPosition_y = 342.146, cpPosition_z = 226.561, cpPosition_r = 50.0,
		},
	},
