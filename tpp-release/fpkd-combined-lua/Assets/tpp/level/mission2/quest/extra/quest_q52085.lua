...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1886.718, cpPosition_y = 320.462, cpPosition_z = 656.199, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1886.718, gtPosition_y = 320.462, gtPosition_z = 656.199, gtPosition_r = 50.0,
		},
	},
