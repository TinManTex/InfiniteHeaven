...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1697.162, cpPosition_y = 149.083, cpPosition_z = -2040.561, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1697.162, cpPosition_y = 149.083, cpPosition_z = -2040.561, cpPosition_r = 50.0,
		},
	},
