...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -696.014, cpPosition_y = -3.893, cpPosition_z = 552.250, cpPosition_r = 90.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -696.014, gtPosition_y = -3.893, gtPosition_z = 552.250, gtPosition_r = 90.0,
		},
	},
