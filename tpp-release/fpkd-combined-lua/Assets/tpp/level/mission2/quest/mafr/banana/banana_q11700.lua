...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 712.199, cpPosition_y = 33.304, cpPosition_z = -911.492, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 712.199, cpPosition_y = 33.304, cpPosition_z = -911.492, cpPosition_r = 50.0,
		},
	},
	...
	enemyList = {
		...
		{ 
			...
			route_d = "rt_savannahNorth_d_0000_sub", 	route_c = "rt_savannahNorth_d_0000_sub",
		...
		{ 
			...
			route_d = "rt_quest_d_0003", 	route_c = "rt_quest_c_0002",
			powerSetting = { "QUEST_ARMOR", "SHOTGUN" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0004",
			route_d = "rt_quest_d_0004", 	route_c = "rt_quest_c_0001",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0005",
			route_d = "rt_quest_d_0005", 	route_c = "rt_quest_c_0003",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0006",
			route_d = "rt_quest_d_0006", 	route_c = "rt_quest_c_0004",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0007",
			route_d = "rt_quest_d_0007", 	route_c = "rt_quest_c_0004",
			powerSetting = { "QUEST_ARMOR", "SHOTGUN" },
			soldierSubType = "PF_C",
		},
	},
