...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 980.130, cpPosition_y = -3.902, cpPosition_z = 276.797, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 980.130, gtPosition_y = -3.902, gtPosition_z = 276.797, gtPosition_r = 50.0,
		},
	},
