...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1601.215, cpPosition_y = 116.148, cpPosition_z = -861.379, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1601.215, gtPosition_y = 116.148, gtPosition_z = -861.379, gtPosition_r = 20.0,
		},
	},
