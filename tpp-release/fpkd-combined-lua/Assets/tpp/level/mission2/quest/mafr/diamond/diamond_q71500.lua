...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1518.195, cpPosition_y = 145.478, cpPosition_z = -2115.688, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1518.195, gtPosition_y = 145.478, gtPosition_z = -2115.688, gtPosition_r = 50.0,
		},
	},
