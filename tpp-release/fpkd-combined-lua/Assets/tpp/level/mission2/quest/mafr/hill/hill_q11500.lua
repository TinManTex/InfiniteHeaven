...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 2354.638, cpPosition_y = 67.450, cpPosition_z = -112.952, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 2354.638, cpPosition_y = 67.450, cpPosition_z = -112.952, cpPosition_r = 50.0,
		},
	},
	...
	enemyList = {
		...
		},
		{
			...
			route_d = "rt_factorySouth_d_0000_sub", 	route_c = "rt_factorySouth_c_0000_sub",
		...
		},
		{
			...
			route_d = "rt_quest_d_0004", 	route_c = "rt_quest_c_0002",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{
