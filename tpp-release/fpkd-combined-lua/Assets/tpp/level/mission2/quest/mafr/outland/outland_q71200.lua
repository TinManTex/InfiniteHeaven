...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -594.489, cpPosition_y = -17.482, cpPosition_z = 1095.318, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -594.489, gtPosition_y = -17.482, gtPosition_z = 1095.318, gtPosition_r = 50.0,
		},
	},
