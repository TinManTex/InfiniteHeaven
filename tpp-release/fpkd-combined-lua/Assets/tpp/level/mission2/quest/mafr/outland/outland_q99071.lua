...
this.QUEST_TABLE = {
	...
	enemyList = {
		...
		},
		{
			...
			route_d = "rt_quest_d_0000", 	route_c = "rt_quest_c_0001",
			cpName = "mafr_outland_cp",
		...
		},
		{
			...
			route_d = "rt_quest_d_0000", 	route_c = "rt_quest_c_0003",
			cpName = "mafr_outland_cp",
...
this.UniqueInterEnd_sol_Gunsmith = function( soldier2GameObjectId, cpID )
