...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1556.253, cpPosition_y = -11.616, cpPosition_z = 1778.964, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1556.253, cpPosition_y = -11.616, cpPosition_z = 1778.964, cpPosition_r = 50.0,
		},
	},
	...
	enemyList = {
		...
		},
		{
			...
			route_d = "rt_chicoVilWest_d_0000_sub", 	route_c = "rt_chicoVilWest_d_0000_sub",
			soldierSubType = "PF_A",
