...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 803.255, cpPosition_y = -11.806, cpPosition_z = 1225.636, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 803.255, gtPosition_y = -11.806, gtPosition_z = 1225.636, gtPosition_r = 50.0,
		},
	},
