...
-- see InfSoldierFaceAndBody which processes fovaInfo addons (mod\modules\fovaInfo)
-- which allow head/faceId additions and soldier bodyId additions (via this faceDefinition and bodyDefinition)
