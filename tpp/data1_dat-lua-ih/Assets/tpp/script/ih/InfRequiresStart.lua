...
--tex Note: this wont catch InfMain at end since that's pushed into _requiresList instead and only done after Tpp .requires loading anyhoo (see InfInitMain)
