...
function this.SaveGameData(t,i,S,a,n)
  ...
  this.CheckAndSavePersonalData(a)end
function this.GetSaveGameDataQueue(n,i,S,t)
  local a=this.GetGameSaveFileName()
  local a=this.GetIntializedCompositSlotSaveQueue(a,i,S,t)
  a=this._SaveGlobalData(a)
  a=this._SaveMissionData(a)
  a=this._SaveMissionRestartableData(a)
  a=this._SaveRetryData(a)
  a=this._SaveMbManagementData(a,n)
  a=this._SaveQuestData(a)
  return a
end
...
function this.Init(a)this.messageExecTable=Tpp.MakeMessageExecTable(this.Messages())
end
function this.OnReload(a)this.messageExecTable=Tpp.MakeMessageExecTable(this.Messages())
end
function this.Messages()
  return Tpp.StrCode32Table{UI={{msg="PopupClose",sender=TppDefine.ERROR_ID.CANNOT_FIND_STORAGE_IN_GAME,func=function()this.ForbidSave()end}}}
end
...
function this.SaveVarsToSlot(t,n,a)
  local e=this.GetSaveFileVersion(a)TppScriptVars.SaveVarsToSlot(t,n,a,e)
end
function this.VarSaveOnlyGlobalData()this.SaveVarsToSlot(TppDefine.SAVE_SLOT.GLOBAL,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_GAME_GLOBAL)
end
function this.VarSave(a,n)this.SaveVarsToSlot(TppDefine.SAVE_SLOT.GLOBAL,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_GAME_GLOBAL)
...
function this.VarSaveOnRetry()this.SaveVarsToSlot(TppDefine.SAVE_SLOT.RETRY,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_RETRY)
end
function this.VarSaveMbMangement(a,n)
  if this.CanSaveMbMangementData(a)
    or n then
    this.SaveVarsToSlot(TppDefine.SAVE_SLOT.MB_MANAGEMENT,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_MB_MANAGEMENT)
  end
end
...
function this.VarSaveConfig()this.SaveVarsToSlot(TppDefine.SAVE_SLOT.CONFIG,TppScriptVars.GROUP_BIT_VARS,TppScriptVars.CATEGORY_CONFIG)
end
function this.VarSaveMGO()this.SaveVarsToSlot(TppDefine.SAVE_SLOT.MGO,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_MGO)
end
function this.VarSavePersonalData()this.SaveVarsToSlot(TppDefine.SAVE_SLOT.PERSONAL,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_PERSONAL)
end
...
local t={
  ...
  TppScriptVars.CATEGORY_QUEST,TppDefine.CATEGORY_MISSION_RESTARTABLE
}
...
function this.CheckSlotVersionConfigData()return this.CheckSlotVersion(TppScriptVars.CATEGORY_CONFIG)
end
function this.IsReserveVarRestoreForContinue()return gvars.sav_varRestoreForContinue
end
function this.ReserveVarRestoreForContinue()gvars.sav_varRestoreForContinue=true
end
function this.ReserveVarRestoreForMissionStart()gvars.sav_varRestoreForContinue=false
end
function this.VarRestoreOnMissionStart()
  if not TppMission.IsFOBMission(vars.missionCode)then
    ...
    TppScriptVars.LoadVarsFromSlot(TppDefine.SAVE_SLOT.MB_MANAGEMENT,TppDefine.VARS_GROUP_GAME_DATA_ON_START_MISSION,TppScriptVars.CATEGORY_MB_MANAGEMENT)TppScriptVars.LoadVarsFromSlot(TppDefine.SAVE_SLOT.QUEST,TppDefine.VARS_GROUP_GAME_DATA_ON_START_MISSION,TppScriptVars.CATEGORY_QUEST)
  end
  TppScriptVars.LoadVarsFromSlot(TppDefine.SAVE_SLOT.CONFIG,TppScriptVars.GROUP_BIT_VARS,TppScriptVars.CATEGORY_CONFIG)TppScriptVars.LoadVarsFromSlot(TppDefine.SAVE_SLOT.PERSONAL,TppScriptVars.GROUP_BIT_VARS,TppScriptVars.CATEGORY_PERSONAL)
  if TppSystemUtility.GetCurrentGameMode()=="MGO"then
...
function this.VarRestoreOnContinueFromCheckPoint()TppScriptVars.LoadVarsFromSlot(TppDefine.SAVE_SLOT.GLOBAL,TppScriptVars.GROUP_BIT_ALL,TppScriptVars.CATEGORY_GAME_GLOBAL)
  if gvars.usingNormalMissionSlot then
...
function this.DeleteGameSaveFile()TppScriptVars.DeleteFile(TppDefine.GAME_SAVE_FILE_NAME)
end
function this.DeleteTemporaryGameSaveFile()TppScriptVars.DeleteFile(TppDefine.GAME_SAVE_FILE_NAME_TMP)
end
function this.DeleteConfigSaveFile()TppScriptVars.DeleteFile(TppDefine.CONFIG_SAVE_FILE_NAME)
end
function this.DeletePersonalDataSaveFile()TppScriptVars.DeleteFile(TppDefine.PERSONAL_DATA_SAVE_FILE_NAME)
end
function this.DeleteMGOSaveFile()TppScriptVars.DeleteFile(TppDefine.MGO_SAVE_FILE_NAME)
end
