...
this.groundStartPositionsInitial={--tex built from /Assets/tpp/ui/Script/mbdvc_map_mission_parameter.lua, intial 'drop' lzs, other lzs in game are called 'assault' lzs??
...
for lzName,lzInfo in pairs(this.groundStartPositionsInitial)do
  this.groundStartPositions[StrCode32(tostring(lzName))]=lzInfo
  this.str32LzToLz[StrCode32(tostring(lzName))]=tostring(lzName)
end
this.groundStartPositionsInitial={}
