...
this.eng={--english
  ...
  revengeMode="Enemy Prep in free mode",
  ...
  revengeModeSettings={"Dynamic (game default)","Custom config"}, -- "Force Max","Use custom prep config"},
  ...
  reinforceLevelMin="Vehicle reinforcement level min",
  reinforceLevelMax="Vehicle reinforcement level max",
  printCustomRevengeConfig="Calculate example config (look in log - all tab)",
  revengeModeForMissions="Enemy Prep in missions",
  revengeIgnoreBlockedMin="Ignore combat-deploy supply blocks min",
  revengeIgnoreBlockedMax="Ignore combat-deploy supply blocks max",
  reinforceCountMin="Reinforce count min",
  reinforceCountMax="Reinforce count max",
