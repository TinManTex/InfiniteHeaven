...
this.eng={--english
  ...
  unlockPlayableAvatarItem="Unlock playable avatar",
  ...
  printSightFormParameterItem="Print sight param table (look in log - all tab)",
...
this.cht={--chinese traditional, translation by rikimtasu,  unconfirmed lang code, use the Patchup > Show language code option to get the language code and contact me on nexus
  ...
  unlockPlayableAvatarItem="解锁Avatar",
