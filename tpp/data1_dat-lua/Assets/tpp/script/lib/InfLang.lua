...
this.eng={--english
  ...
  printCustomRevengeConfig="Print example current config (look in log - all tab)",
...
this.help.eng={
  ...
  subsistenceProfile="Pure - similar to the games Subsistence mission settings with additional restrictions, Bounder - a bit more relaxed than Pure profile, mainly allowing any character as well as buddies.",
  ...
  ospMenu="Separate from subsistence mode (but subsistence uses it), allows you to enter a mission with primary and secondary weapons set to none, individually settable.",
  ...
  revengeCustomMenu="Lets you set the individual values that go into an enemy prep configuration (oes not use the enemy prep levels), a value random between MIN and MAX for each setting is chosen on mission start",
  weaponStrengthCustomMenu="Whether to deploy the stronger weapon type",
  ...
  mbEnableBuddies="Allows all buddy types to be on mother base (still one at a time), many will however start inside the building and require you to call from the buddy menu.",
