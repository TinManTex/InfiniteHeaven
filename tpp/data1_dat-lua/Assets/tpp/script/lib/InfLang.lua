...
this.eng={--english
  ...
  set_goBackItem={">","Back"},
  set_dd_equip_grade={"Off","Developed","Random","Grade 1","Grade 2","Grade 3","Grade 4","Grade 5","Grade 6","Grade 7","Grade 8","Grade 9","Grade 10"},
  ...
  mbDDSuitSettings={"Off","Use Equip Grade","Drab","Tiger","Sneaking","Battle Dress","PF Riot Suit (bugs female face)"},
  ...
  enemyDDEquipMenu="Enemy DD Equip menu",
  enableMbDDEquip="Equip DD",
  enableEnemyDDEquip="Enemy use DD equipment",
