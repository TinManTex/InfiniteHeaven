...
this.eng={--english
  ...
  revengeMode="Enemy Preparedness in free mode",
  ...
  revengeCustomMenu="Custom prep config menu",--r117
  revengeSystemMenu="Prep system menu",
  revengeModeSettings={"Dynamic (default)", "Force Max","Use custom prep config"},
  ...
  reinforceLevelCustom="Vehicle reinforcement level",
  printCustomRevengeConfig="Calculate example config (look in log - all tab)",
  revengeModeForMissions="Enemy Preparedness in missions",
  revengeCustomIgnoreBlocked="Ignore combat-deploy supply blocks",
  reinforceCount="Reinforce count",
