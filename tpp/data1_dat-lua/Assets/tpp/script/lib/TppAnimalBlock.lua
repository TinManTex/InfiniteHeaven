...
function e._SetHerdRoute(e,a,n,t)
  ...
  local t={id="SetHerdEnabledCommand",type="Route",name=a,instanceIndex=0,route=t}GameObject.SendCommand(e,t)
end
function e._SetRoute(e,a,n,t)
  ...
  local a=string.format(a,t)
  local t=string.format(n,t)
  local t={id="SetRoute",name=a,route=t}GameObject.SendCommand(e,t)
end
function e._ChangeDeadState(e,t,a)
  ...
  local t=a or 0
  local t={id="ChangeDeadState",position=n,degRotationY=t}GameObject.SendCommand(e,t)
end
...
function e._RegisterClockMessage(t,i,o,n,a,l)
  local t=string.format(t,a)e._RegisterWeatherTable(t,n,l)
  local e=i+o*a
...
function e._MakeMessageExecTable()mvars.animalBlockScript.messageExecTable=Tpp.MakeMessageExecTable(mvars.animalBlockScript.Messages)
end
...
function e.OnInitializeAnimalBlock()coroutine.yield()coroutine.yield()
  ...
  for o,n in pairs(t)do
    ...
    if n~=nil and t~="NoAnimal"then
      e._InitializeCommonAnimalSetting(t,a,n)e._AddClockMessage(t,a,n,l)
...
function e.OnAllocate(a)
  local t=d()
  TppScriptBlock.InitScriptBlockState(t)mvars.animalBlockScript=a
  local t,a=Tpp.GetCurrentStageSmallBlockIndex()e._UpdateActiveAnimalBlock(t,a)
...
function e.OnTerminate()
  ...
  TppFreeHeliRadio.UnregistAnimalOptionalRadio()mvars.animalBlockScript.DidInitialized=nil
