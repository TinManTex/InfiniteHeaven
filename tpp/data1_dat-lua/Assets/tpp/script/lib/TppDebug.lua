...
local a=t(a)e(a,{id="SetEnabled",enabled=false})e(a,{id="SetSneakRoute",route=o,point=r})e(a,{id="SetCautionRoute",route=o,point=r})
if n then
...
local a=t(a)e(a,{id="SetEnabled",enabled=false})e(a,{id="SetSneakRoute",route=n,point=r})e(a,{id="SetCautionRoute",route=n,point=r})
if l then
...
function a.DEBUG_AddSkipLogSVarsName(e)a.DEBUG_SkipOnChangeSVarsLog[e]=true
end
...
e(r,{1,.5,.5},"Now gvars.usingNormalMissionSlot is false, but not emergency mission. Call scripter!!!!!!")
end
...
e(r,{1,.5,.5},"Now vars.fobSneakMode isFobMode.MODE_SHAM, but not fob mission. Call scripter!!!!!!")
end
...
local a=a.DEBUG_GetSysVarsLog()e(r,{.5,.5,1},"LuaSystem showSysVars")
for o,a in ipairs(a)do
e(r,a)
end
local a={[FobMode.MODE_ACTUAL]="MODE_ACTUAL",[FobMode.MODE_SHAM]="MODE_SHAM",[FobMode.MODE_VISIT]="MODE_VISIT",[FobMode.MODE_NONE]="MODE_NONE"}e(r,"vars.fobSneakMode = "..tostring(a[vars.fobSneakMode]))
local a=TppScriptVars.GetVarValueInSlot(TppDefine.SAVE_SLOT.MB_MANAGEMENT,"vars","mbmTppGmp",0)e(r,"GMP(inSlot) = "..tostring(a))
local a=TppScriptVars.GetVarValueInSlot(TppDefine.SAVE_SLOT.MB_MANAGEMENT,"vars","mbmTppHeroicPoint",0)e(r,"HeroicPoint(inSlot) = "..tostring(a))
end
if gvars.DEBUG_showGameStatus then
e(r,"")e(r,{.5,.5,1},"LuaSystem gameStatus")
...
local a={"PRIMARY_HIP","PRIMARY_BACK","SECONDARY"}e(r,{.5,.5,1},"LuaSystem WeaponVars")
for a,o in ipairs(a)do
local a=TppDefine.WEAPONSLOT[o]e(r,string.format("Slot:%16s : vars.initWeapons = %04d, vars.weapons = %04d",o,vars.initWeapons[a],vars.weapons[a]))
end
for a=0,7 do
e(r,string.format("Slot:%d : vars.supportWeapons = %04d, vars.initSupportWeapons = %04d, gvars.ply_lastWeaponsUsingTemp = %04d",a,vars.supportWeapons[a],vars.initSupportWeapons[a],gvars.ply_lastWeaponsUsingTemp[a+TppDefine.WEAPONSLOT.SUPPORT_0]))
end
for a=0,7 do
e(r,string.format("Slot:%d : vars.items = %04d, vars.initItems = %04d, gvars.ply_lastItemsUsingTemp = %04d",a,vars.items[a],vars.initItems[a],gvars.ply_lastItemsUsingTemp[a]))
end
end
...
if not o then
o="threshold is"end
e(r,string.format("   Task %1d : [%s] %s %06.2f : ( Current %06.2f )",a,n,o,t[a].threshold,FobUI.GetCurrentEventTaskValue(a,i)))
end
end
e(r,{.5,1,.5},"FobSneak eventTask")
for a=0,7 do
...
e(r,{.5,1,.5},"FobDefence eventTask")
for a=0,7 do
...
local r=e.color or"white"local e=e.text or""r=a._GetColor(r)GrxDebug.Print2D{life=t,x=o,y=n,size=s,color=r,args={e}}
end
...
function a.AddReturnToSelector(e)e:AddItem("< return",DebugSelector.Pop)
end
...
local e={}d(e,TppDbgStr32.DEBUG_strCode32List)
...
a="Outside"else
a="Inside"end
o(r,"hotZone : "..a)o(r,"hotZone clear check : isNotAlert = "..(tostring(e.debug.notHotZone_isNotAlert)..(", isPlayerStatusNormal = "..(tostring(e.debug.notHotZone_isPlayerStatusNormal)..(", isNotHelicopter = "..tostring(e.debug.notHotZone_isNotHelicopter))))))o(r,"Mission clear timer: "..tostring(u"Timer_OutsideOfHotZoneCount"))o(r,{.5,1,.5},"Recent all target status")
...
n="exist"else
n="  not"end
o(r,"OnMessage "..(tostring(t)..(" OnReload "..tostring(n))))a.ShowMessageTable(r,"MessageTable",e.animalBlockScript.messageExecTable)
else
...
function a.ErrorNotSupportYet(e)
end
