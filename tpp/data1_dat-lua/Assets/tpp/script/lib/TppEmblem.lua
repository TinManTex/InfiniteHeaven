...
this._AcquireByMissionCode(r,a)
end
function this.AcquireOnMissionClear(r)
this._AcquireByMissionCode(a,r)
end
function this.AcquireOnAllMissionTaskComleted(r)
this._AcquireByMissionCode(n,r)
end
...
function this.AcquireByPlayStyle(r)
  ...
  if r then
    ...
    local r=string.format("word%04d",r)this.Add(a,true)this.Add(r,true)
  end
end
