...
function e.Messages()
return n{Player={{msg="CalcFultonPercent",func=function(n,i,n,n,n)
...
local n="f2000_rtrg0060"local i=a(i,{id="GetStateFlag"})
...
end}},GameObject={{msg="PlayerGetAway",func=function(n)
if Tpp.IsHostage(n)then
e._UnregisterOptionRadio"f2000_oprg0105"end
end},{msg="PlayerGetNear",func=function(n)
if Tpp.IsHostage(n)then
e._RegisterOptionRadio"f2000_oprg0105"end
end},{msg="Unconscious",func=function(i)
...
end},{msg="FultonFailed",func=function(i,t,t,n)
...
end}},Weather={{msg="Clock",sender="ChangeDayToNight",func=function(n,n)
e.RegistNvgOptionRadio()
end},{msg="Clock",sender="ChangeNightToDay",func=function(n,n)
e.UnregistNvgOptionRadio()
end},{msg="ChangeWeathre",func=function(i)
local n="f2000_oprg0185"if i==TppDefine.WEATHER.SANDSTORM then
e._RegisterOptionRadio(n)
else
e._UnregisterOptionRadio(n)
end
end}},Radio={{msg="Finish",sender="f1000_rtrg3120",func=function()
...
local n=TppClock.GetTime"time"return(n>=e.DAY_TIME)and(n<=e.NIGHT_TIME)
end
return e
