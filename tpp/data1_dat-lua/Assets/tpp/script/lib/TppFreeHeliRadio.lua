...
function e.Messages()
  return n{
  Player={
  {msg="CalcFultonPercent",func=function(n,i,n,n,n)
  ...
  {msg="PlayerGetAway",func=function(n)
    ...
    end}},Weather={{msg="Clock",sender="ChangeDayToNight",func=function(n,n)e.RegistNvgOptionRadio()
    end},{msg="Clock",sender="ChangeNightToDay",func=function(n,n)e.UnregistNvgOptionRadio()
...
function e._OnReload()e.SetupMessages()
end
function e.OnReload()
...
function e.SetupMessages()e.messageExecTable=Tpp.MakeMessageExecTable(e.Messages())
end
...
function e._RegisterOptionRadio(e)
  local n=mvars.FreeHeliRadio_addOptionRadioCount[e]if n then
...
function e._IsRegistOptionRadio(e)
  return mvars.FreeHeliRadio_addOptionRadioCount[e]end
