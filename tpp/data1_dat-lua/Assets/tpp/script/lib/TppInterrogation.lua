...
function e.Messages()
return Tpp.StrCode32Table{GameObject={{msg="Interrogate",func=e._OnInterrogation},{msg="InterrogateEnd",func=e._OnInterrogationEnd},{msg="MapUpdate",func=e._OnMapUpdate}}}
end
