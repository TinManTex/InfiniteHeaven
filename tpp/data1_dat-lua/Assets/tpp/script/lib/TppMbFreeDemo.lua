...
e.demoBlockList={
  ...
  SnakeHasBadSmell_001={"/Assets/tpp/pack/mission2/free/f30050/f30050_d022.fpk",b},EliLookSnake={"/Assets/tpp/pack/mission2/free/f30050/f30050_d080.fpk"},
...
e.demoOptions={
  ...
  LongTimeNoSee_DdogPup={time="12:00:00",weather=TppDefine.WEATHER.SUNNY,OnEnd=function()
    TppBuddyService.SetBuddyPuppyMBDemoPlayed()gvars.elapsedTimeSinceLastPlay=0
  end,
  heliEnableAfterDemo=true,
  demoEndRouteList={{locatorName="ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|TppOcelot2GameObjectLocator",routeName="ly003_cl00_route0000|cl00pl0_uq_0000_free|rt_p51_010160_0000"}},
  isUseGrassOcelot=true,
  enableOcelotDemoEnd=true},
  LongTimeNoSee_DdogLowLikability={time="12:00:00",weather=TppDefine.WEATHER.CLOUDY,heliEnableAfterDemo=true,OnEnd=function()
    gvars.elapsedTimeSinceLastPlay=0
  end,
  ...
  LongTimeNoSee_DdogHighLikability={time="12:00:00",weather=TppDefine.WEATHER.SUNNY,heliEnableAfterDemo=true,OnEnd=function()
    gvars.elapsedTimeSinceLastPlay=0
  end,
  demoEndRouteList={{locatorName="ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|TppOcelot2GameObjectLocator",routeName="ly003_cl00_route0000|cl00pl0_uq_0000_free|rt_p51_010060_0000"}},
  enableOcelotDemoEnd=true,isUseGrassOcelot=true,loadBuddyBlock=true,forceEnableBuddyType=BuddyType.DOG},
  LongTimeNoSee_DdogSuperHighLikability={time="12:00:00",weather=TppDefine.WEATHER.SUNNY,heliEnableAfterDemo=true,OnEnd=function()
    gvars.elapsedTimeSinceLastPlay=0
  end,
  demoEndRouteList={{locatorName="ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|TppOcelot2GameObjectLocator",routeName="ly003_cl00_route0000|cl00pl0_uq_0000_free|rt_p51_010060_0000"}},
  enableOcelotDemoEnd=true,isUseGrassOcelot=true,loadBuddyBlock=true,forceEnableBuddyType=BuddyType.DOG},
  AttackedFromOtherPlayer_KnowWhereFrom={time="14:00:00",weather=TppDefine.WEATHER.CLOUDY,OnEnd=function()
  ...
  heliEnableAfterDemo=true,
  demoSoldierLocator={"ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt0_0000","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt0_0002","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt0_0005","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt1_0000","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt1_0001","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt1_0002","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt1_0003"},
  forceMaleLocator={"ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt0_0001","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt0_0003","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt0_0004","ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt2_0000"},
  forceBalaclavaLocator={}},
  ...
  QuietHasFriendshipWithChild={plntName="plnt1",clusterName="Medical",time="19:00:00",weather=TppDefine.WEATHER.SUNNY,isFinishFadeOut=true,OnPrevPlayRequest=function()
  ...
  OnEnd=function()
    ...
    TppPlayer.Warp{pos=t,rotY=e}
    Player.RequestToSetCameraRotation{rotX=0,rotY=e}
    TppPlayer.SetInitialPosition(t,e)mvars.f30050_isOverwriteDemoEndPos=true
  ...
  isFinishFadeOut=true},
  SnakeHasBadSmell_WithoutQuiet={time="20:00:00",weather=TppDefine.WEATHER.CLOUDY,heliEnableAfterDemo=true,OnEnd=function()Player.OnPlayerRefresh()
    end,
    ...
    enableOcelotDemoEnd=true,demoSoldierLocator={"ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt1_0001"},
    ...
    loadBuddyBlock=true},
  SnakeHasBadSmell_000={GetNextDemoNameOrNil=function()
    return"SnakeHasBadSmell_001"
  end,
  time="20:00:00",weather=TppDefine.WEATHER.CLOUDY,demoSoldierLocator={"ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt2_0002"},
  ...
  SnakeHasBadSmell_001={clusterName="Medical",weather=TppDefine.WEATHER.CLOUDY,time="20:00:00",OnEnd=function()
    Player.OnPlayerRefresh()
  end,
  demoSoldierLocator={},
  ...
  DevelopedBattleGear1={weather=TppDefine.WEATHER.SUNNY,noUseDemoBlock=true,noHeli=true,OnEnter=function()
    ...
    local e="mtbs_door006_door004_ev_gim_n0000|srt_mtbs_door006_door004_ev"Gimmick.InvisibleGimmick(TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,e,t,true)
  ...
  OnEnd=function()
    ...
    local t="mtbs_door006_door004_ev_gim_n0000|srt_mtbs_door006_door004_ev"Gimmick.InvisibleGimmick(TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,t,e,false)
  ...
  DevelopedBattleGear2={weather=TppDefine.WEATHER.SUNNY,noUseDemoBlock=true,noHeli=true,OnEnter=function()
    local e="/Assets/tpp/level/location/mtbs/block_large/mtbs_hanger_gimmick.fox2"
    local t="mtbs_door006_door004_ev_gim_n0000|srt_mtbs_door006_door004_ev"Gimmick.InvisibleGimmick(TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,t,e,true)
  ...
  OnEnd=function()
    local t="/Assets/tpp/level/location/mtbs/block_large/mtbs_hanger_gimmick.fox2"
    local e="mtbs_door006_door004_ev_gim_n0000|srt_mtbs_door006_door004_ev"Gimmick.InvisibleGimmick(TppGameObject.GAME_OBJECT_TYPE_EVENT_ANIMATION,e,t,false)
  ...
  ParasiticWormCarrierKill={time="07:00:00",weather=TppDefine.WEATHER.CLOUDY,OnEnd=function()
  ...
  OnEnd=function()
    ...
    TppCassette.Acquire{cassetteList={"tp_m_10190_05","tp_m_10190_06","tp_m_10240_03","tp_m_10240_04"},
      pushReward=true}
    ...
    TppEffectUtility.RestoreOceanParameters()vars.mbmBanHeuy=1
    if f30050_sequence then
      f30050_sequence.ReserveMissionClear()
    end
  end,
  ...
  PazPhantomPain2={OnEnter=function()
    TppDataUtility.SetVisibleDataFromIdentifier("uq_0040_paz_room_AssetIdentifier","paz_room_phantom",true,false)
    TppDataUtility.SetVisibleDataFromIdentifier("uq_0040_paz_room_AssetIdentifier","paz_room_real",false,false)
    TppDataUtility.SetVisibleDataFromIdentifier("uq_0040_paz_room_bed_AssetIdentifier","paz_room_bed",true,false)
    TppDataUtility.SetVisibleDataFromIdentifier("uq_0040_paz_room_AssetIdentifier","paz_room_phantom_door",false,false)
  ...
  OnEnd=function()f30050_sequence.SetPazDone()
  end,
...
function e.PlayMtbsEventDemo(o)
  ...
  if m then
    local e=e.demoList[l]TppMovie.Play{videoName=e,onStart=t.onStart,onEnd=t.onend,memoryPool=e}
  else
    TppDemo.Play(l,t,n)
  end
end
