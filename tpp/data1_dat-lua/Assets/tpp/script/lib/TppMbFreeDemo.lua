...
this.demoOptions={
  ...
  OcelotIsPupilOfSnake={time="13:00:00",weather=TppDefine.WEATHER.SUNNY,heliEnableAfterDemo=true,demoEndRouteList={{locatorName="ly003_cl00_npc0000|cl00pl0_uq_0000_npc2|sol_plnt1_0001",routeName="ly003_cl00_route0000|cl00pl0_uq_0000_free|rt_p51_010350_0000"},
  ...
  enableOcelotDemoEnd=true},
  HappyBirthDay={GetNextDemoNameOrNil=function()
...
localt="/Assets/tpp/level/location/mtbs/block_area/ly00"..(tostring(vars.mbLayoutCode)..("/cl00/mtbs_ly00"..(tostring(vars.mbLayoutCode).."_cl00_item.fox2")))
...
Player.OnPlayerRefresh()
  ...
  OnEnd=function()
    TppPlayer.SetInitialPosition({10.762,0,-6.521},
      90)
    mvars.f30050_isOverwriteDemoEndPos=true
  ...
  GoToMotherBaseAfterQuietBattle={noHeli=true,outOfCluster=true,GetNextDemoNameOrNil=function()
    return"ArrivedMotherBaseAfterQuietBattle"end,
  weather=TppDefine.WEATHER.SUNNY,time="14:30:00",enableWaitBlockLoadOnDemoSkip=false,OnEnter=function()
  ...
  loadBuddyBlock=true},
  ArrivedMotherBaseLiquid={time="20:00:00",weather=TppDefine.WEATHER.SUNNY,OnEnd=function()
  ...
  time="17:00:00",weather=TppDefine.WEATHER.SUNNY,clusterName="Medical"},
  PazPhantomPain4=this._PazPhantomPain4Settings,PazPhantomPain4_jp=this._PazPhantomPain4Settings}
function this.PlayMtbsEventDemo(o)
  if not Tpp.IsTypeTable(o)then
  end
  local demoName=o.demoName
  ...
  local r=nil
  local p=nil
  local t=this.demoOptions[demoName]
  local i,a=nil,nil
  local n=this.GetNextDemo(demoName)
  local S=nil
  local T=nil
  local m=false
  local u=false
  ...
  local t={onInit=function()
    ...
    DemoDaemon.SetDemoTransform(f30050_demo.demoList[demoName],t,n)
    if not c then
      if T then
  ...
  onEnd=function()
    ...
    local t=TppDefine.MB_FREEPLAY_DEMO_ENUM[demoName]
    if t then
...
function this.DisableBuddyForForceRealized(demoName)
  ...
  if demoOptions and(demoOptions.forceEnableBuddyType or demoOptions.disableBuddyAfterDemo)then
