...
e.storySequenceTable_Master={{main="s10010"},{main="s10020"},{main="s10030"},{flag={"s10036","s10043","s10033"},proceedCount=2},{main="s10040"},{flag={"s10041","s10044","s10052","s10054"},sub={"s10050"},defaultClose={s10050=true},proceedCount=3,condition=function()
local e
...
return e
end,updateTiming={OnMissionStart=true,OnCompletedPlatform=true}},{main="s10070",defaultClose={s10070=true}},{main="s10080"},{flag={"s10086"}},{flag={"s10082"}},{main="s10090",condition=function()
if TppMotherBaseManagement.CanOpenS10091()then
TppMotherBaseManagement.LockedStaffsS10091()
end
return true
end},{flag={"s10091"}},{main="s10100",flag={"s10195"}},{main="s10110"},{flag={"s10121","s10115"},defaultClose={s10115=true}},{main="s10120"},{flag={"s10085","s10200"}},{flag={"s10211"},condition=function()
...
return true
end},{flag={"s10081"}},{main="s10130"},{main="s10140"},{main="s10150"},{main="s10151",condition=function()
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,2)
TppQuest.StartElapsedEvent(1)
return true
end},{flag={"s10045"},sub={"s11043","s11054"},condition=function()
if TppQuest.IsCleard"tent_q99040"then
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,2)
TppQuest.StartElapsedEvent(1)
return true
end
end,updateTiming={OnSideOpsClear=true,OnMissionStart=true}},{flag={"s10093"},sub={"s11082","s11090"},condition=function()
return TppQuest.OpenChildSoldier_1()
end,updateTiming={OnSideOpsClear=true,OnMissionStart=true}},{flag={"s10156"},sub={"s11033","s11050"},defaultClose={s11050=true},condition=function()
return(TppQuest.IsCleard"tent_q20910"and TppQuest.IsCleard"fort_q20911")and TppQuest.IsCleard"sovietBase_q20912"end,updateTiming={OnMissionStart=true,OnSideOpsClear=true}},{main="s10171",condition=function()
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,1)
TppQuest.StartElapsedEvent(3)
return true
end},{sub={"s11140"},condition=function()
...
end,updateTiming={OnMissionStart=true,OnUpdateCheckPoint=true,OnSideOpsClear=true}},{main="s10240",defaultClose={s10240=true},condition=function()
e.StartElapsedMissionEvent(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE,1)
TppQuest.StartElapsedEvent(3)
return true
end},{sub={"s11080"},condition=function()
...
end,updateTiming={OnMissionStart=true,OnSideOpsClear=true}},{sub={"s11121"},condition=function()
...
end,updateTiming={OnMissionStart=true,OnSideOpsClear=true}},{sub={"s11130","s11044","s11151","s10260","s10280"},defaultClose={s10260=true,s10280=true},condition=function()
...
return e.demoName=="AttackedFromOtherPlayer_UnknowWhereFrom"or e.demoName=="AttackedFromOtherPlayer_KnowWhereFrom"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0500"}},NuclearEliminationCeremony={storyCondition=function()
return true
end,detailCondition=function()
...
return e.demoName=="NuclearEliminationCeremony"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0325"}},EntrustDdog={storyCondition=function()
...
return e.demoName=="EntrustDdog"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0350"}},MoraleOfMBIsLow={storyCondition=function()
return true
end,detailCondition=function()
...
return e.demoName=="MoraleOfMBIsLow"end,detailCondition=function()
return TppDemo.mtbsPriorityFuncList.MoraleOfMBIsLow()
end,radioList={"f6000_rtrg0370"}},DdogComeToGet={storyCondition=function()
...
return e.demoName=="DdogComeToGet"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0380"}},DdogGoWithMe={storyCondition=function()
return true
end,detailCondition=function()
return TppDemo.mtbsPriorityFuncList.DdogGoWithMe()
end,demoName="DdogGoWithMe"},DdogGoWithMeRadio={storyCondition=function(e)
return e.demoName=="DdogGoWithMe"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0370"}},HappyBirthDayWithQuiet={storyCondition=function()
return true
end,detailCondition=function()
...
return e.demoName=="HappyBirthDay"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0511"}},QuietTreatment={storyCondition=function(e)
return e.demoName=="ArrivedMotherBaseAfterQuietBattle"end,detailCondition=function(e)
...
end,radioList={"f2000_rtrg1345","f2000_rtrg1347"}},QuietTreatment2={storyCondition=function(e)
return e.demoName=="ArrivedMotherBaseAfterQuietBattle"end,detailCondition=function(e)
...
end,radioList={"f2000_rtrg1345","f2000_rtrg1346"}},QuietReceivesPersecution={storyCondition=function()
...
return e.demoName=="QuietReceivesPersecution"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0360"}},QuietHasFriendshipWithChild={storyCondition=function()
...
return e.demoName=="QuietHasFriendshipWithChild"end,detailCondition=function()
return true
...
end,radioList={"f6000_rtrg0350","f2000_rtrg7350"}},InterrogateQuiet={storyCondition=function()
local t=TppQuest.IsNowOccurringElapsed()
local n=e.IsNowOccurringElapsedMission(TppDefine.ELAPSED_MISSION_EVENT.STORY_SEQUENCE)
...
return e.CanPlayDemoOrRadio"InterrogateQuiet"end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0330","f2000_rtrg7330"}},QuietPassage={storyCondition=function()
...
return false
end,radioList={"f2000_rtrg1350"}},WalkerGear={storyCondition=function()
...
end,radioList={"f2000_rtrg8420"}},WalkerGearRemind={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_FLAG_MISSIONS_AFTER_FIND_THE_SECRET_WEAPON
end,detailCondition=function()
return e.GetClearedMissionCount{10041,10044,10052,10054}==4
end,radioList={"f2000_rtrg8421"}},AnableDevBattleGear={storyCondition=function()
...
return true
end,radioList={"f6000_rtrg0300"}},AfterAnableDevbattleGear={storyCondition=function()
return TppDemo.IsPlayedMBEventDemo"AnableDevBattleGear"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg1515"}},DevelopedBattleGear_1={storyCondition=function()
...
return e.CanPlayDemoOrRadio"DevelopedBattleGear_1"end,detailCondition=function()
return true
end,radioList={"f6000_rtrg0400"}},OpenFindTheSecretWeapon={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_FLAG_MISSIONS_AFTER_TO_MATHER_BASE
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8030"}},CleardFindTheSecretWeapon={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_FIND_THE_SECRET_WEAPON
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8060"}},CleardToMotherBase={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_TO_MATHER_BASE
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8000"}},OpenPicthDark={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8090"}},ZeroAndScalFace={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_HUEY
end,detailCondition=function()
local n=TppRadio.IsPlayed"f2000_rtrg8090"local e=TppMission.IsHelicopterSpace(vars.missionCode)
return n and e
end,radioList={"f2000_rtrg8100"}},OpenLinguaFranka={storyCondition=function()
return e.IsMissionCleard(10080)and e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_DESTROY_THE_FLOW_STATION
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8115"}},OpenRemovalWalkerGear={storyCondition=function()
return e.IsMissionCleard(10086)and e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_LINGUA_FRANKA
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8120"}},OpenCarLine={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8130"}},OpenRescueIntelAgents={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_TAKE_OUT_THE_CONVOY
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8140"}},OpenEliminateThePows={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_INTEL_AGENTS
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8150"}},OpenVoice={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_ELIMINATE_THE_POWS
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8160"}},OpenCaptureTheWeaponDealer={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_DEATH_FACTORY
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8180"}},OpenWhiteMamba={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_CAPTURE_THE_WEAPON_DEALER
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8185"}},OpenFlagMissionAfterWhiteMamba={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_WHITE_MAMBA
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8440"}},GeneOfEli={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8200"}},ParasiticWormCarrierQuarantine={storyCondition=function()
local n=vars.missionCode==10085 or vars.missionCode==10200
...
return true
end,radioList={"f6000_rtrg0310"}},OpenHuntDown={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_FLAG_MISSIONS_AFTER_WHITE_MAMBA
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8210"}},OpenEliChallengeAndRootCause={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8220"}},OpenEliChallenge={storyCondition=function()
return e.GetCurrentStorySequence()>=TppDefine.STORY_SEQUENCE.CLEARD_ELIMINATE_THE_COMMANDER
end,detailCondition=function()
return TppQuest.IsOpen"mtbs_q99050"and(not TppQuest.IsCleard"mtbs_q99050")
end,radioList={"f2000_rtrg8190"}},ClearEliChallenge={storyCondition=function(e)
return e.clearSideOpsName=="mtbs_q99050"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg1500"}},OpenCodeTalker={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_RESCUE_THE_BETRAYER
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8230"}},OpenMetallicArchaea={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_CODE_TALKER
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8240"}},OpenFlagMissionAfterOKBZERO={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8260"}},CanDevelopNuclear={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_OKB_ZERO
end,detailCondition=function()
return TppMission.IsHelicopterSpace(vars.missionCode)
end,radioList={"f2000_rtrg8261"}},RafeAccidentalDeath={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8280"}},OpenSideOpsAiPod={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8270"}},EliLookSnake={storyCondition=function()
return e.CanPlayDemoOrRadio"RafeAccidentalDeath"end,detailCondition=function()
return true
...
end,radioList={"f6000_rtrg0325","f2000_rtrg7325"}},CompliteDevelopBattleGear={storyCondition=function()
return e.CanPlayDemoOrRadio"OpenSideOpsAiPod"end,detailCondition=function()
return true
end,demoName="DevelopedBattleGear5"},CompliteDevelopBattleGearRadio={storyCondition=function()
return e.CanPlayDemoOrRadio"CompliteDevelopBattleGear"end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg2120","f2000_rtrg7120"}},AfterCompliteDevelopBattleGear={storyCondition=function(e)
return e.demoName=="DevelopedBattleGear5"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg1517"}},LiquidAndChildSoldier={storyCondition=function()
...
return e.clearSideOpsName=="sovietBase_q99030"end,detailCondition=function()
TppQuest.OpenAndActivateSpecialQuest{"tent_q99040"}
return true
end,radioList={"f2000_rtrg1530","f2000_rtrg1540"}},AfterRetrieveVolgin={storyCondition=function(e)
return e.clearSideOpsName=="tent_q99040"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8450"}},CorpseInAIPod={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8370"}},StartQuestChildSoldier={storyCondition=function()
return TppQuest.OpenChildSoldier_1()
end,detailCondition=function()
TppCassette.Acquire{cassetteList={"tp_m_10160_05"},isShowAnnounceLog={delayTimeSec=2}}
return true
end,radioList={"f2000_rtrg8451","f2000_rtrg8290"}},ProgressQuestChildSoldier={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8310"}},LeakRadiationInMB={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8380"}},OpenProxyWar={storyCondition=function()
return e.GetCurrentStorySequence()==TppDefine.STORY_SEQUENCE.CLEARD_FLAG_MISSIONS_BEFORE_ENDRESS_PROXY_WAR
end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8452"}},EliImprisonment={storyCondition=function()
return e.CanPlayDemoOrRadio"TheGreatEscapeLiquid"end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0332","f2000_rtrg7332"}},TheGreatEscapeLiquid={storyCondition=function()
...
return e.demoName=="TheGreatEscapeLiquid"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8350"}},OpenMissionAfterTheGreatEscapeLiquid={storyCondition=function()
return TppDemo.IsPlayedMBEventDemo"TheGreatEscapeLiquid"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8453"}},ReasonSahelanMove={storyCondition=function()
return TppDemo.IsPlayedMBEventDemo"TheGreatEscapeLiquid"end,detailCondition=function()
...
return false
end,radioList={"f2000_rtrg8360"}},PermitParasiticWormCarrierKill={storyCondition=function()
return e.CanPlayDemoOrRadio"ParasiticWormCarrierKill"end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0335","f2000_rtrg7335"}},OpenParasiticWormCarrierKill={storyCondition=function()
return TppDemo.IsPlayedMBEventDemo"ParasiticWormCarrierKill"end,detailCondition=function()
return true
end,radioList={"f2000_rtrg8391"}},ParasiticWormCarrierKill={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8900"}},AfterParasiticWormCarrierKillHeli={storyCondition=function()
...
return true
end,radioList={"f2000_rtrg8400"}},OpenDecisionHuey={storyCondition=function()
return e.CanPlayDemoOrRadio"DecisionHuey"end,detailCondition=function(e)
return true
end,selectRadioFunction=function(e)
if e.clearSideOpsName then
...
end,radioList={"f6000_rtrg0338","f2000_rtrg7338"}},DecisionHuey={storyCondition=function()
...
end,radioList={"f2000_rtrg2000","f2000_rtrg2010"}},AboutHeliSpace={storyCondition=function()
return e.IsMissionCleard(10030)
end,detailCondition=function()
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f2000_rtrg1010"}},AboutSideOps={storyCondition=function()
...
end,radioList={"f1000_rtrg4030"}},AboutQuietSniper={storyCondition=function()
...
end,radioList={"f2000_rtrg1330"}},AboutGunsmith_B={storyCondition=function()
return TppQuest.IsActive"sovietBase_q99070"end,detailCondition=function()
return((TppMission.GetMissionID()~=30050)and(TppMission.GetMissionID()~=30150))and(TppMission.GetMissionID()~=30250)
end,radioList={"f1000_rtrg5100"}},AboutGunsmith_Master={storyCondition=function()
return TppQuest.IsActive"tent_q99072"end,detailCondition=function()
return((TppMission.GetMissionID()~=30050)and(TppMission.GetMissionID()~=30150))and(TppMission.GetMissionID()~=30250)
end,radioList={"f1000_rtrg5110"}},AboutAnalyzer={storyCondition=function()
...
return((TppMission.GetMissionID()~=30050)and(TppMission.GetMissionID()~=30150))and(TppMission.GetMissionID()~=30250)
end,radioList={"f1000_rtrg5120"}},SuggestActiveSonar={storyCondition=function()
...
return((TppMission.GetMissionID()~=30050)and(TppMission.GetMissionID()~=30150))and(TppMission.GetMissionID()~=30250)
end,radioList={"f1000_rtrg4550"}},UnlockBuddyDog={storyCondition=function()
return TppDemo.IsPlayedMBEventDemo"DdogGoWithMe"end,detailCondition=function()
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f2000_rtrg1410"}},UnlockBuddyQuiet={storyCondition=function()
return e.CanArrivalQuietInMB(true)and TppBuddyService.CanSortieBuddyType(BuddyType.QUIET)
end,detailCondition=function()
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f1000_rtrg4590"}},AboutCallBuddy={storyCondition=function()
...
return false
end,radioList={"f1000_rtrg4560","f1000_rtrg4570"}},AboutBuddyDog={storyCondition=function()
return TppBuddyService.CanSortieBuddyType(BuddyType.DOG)
end,detailCondition=function()
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f1000_rtrg4580"}},UnlockIntelSearch={storyCondition=function()
...
return((TppMission.GetMissionID()~=30050)and(TppMission.GetMissionID()~=30150))and(TppMission.GetMissionID()~=30250)
end,radioList={"f2000_rtrg1300"}},UnlockSupportFire={storyCondition=function()
...
return((TppMission.GetMissionID()~=30050)and(TppMission.GetMissionID()~=30150))and(TppMission.GetMissionID()~=30250)
end,radioList={"f2000_rtrg1310"}},AntiNuclearDeterrence={storyCondition=function()
return TppHero.IsHero()
end,detailCondition=function()
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f2000_rtrg1520"}},NuclearWorld={storyCondition=function()
...
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f2000_rtrg1525"}},MotherBaseBurnOut={storyCondition=function()
...
return TppMission.IsHelicopterSpace(TppMission.GetMissionID())
end,radioList={"f2000_rtrg1080"}},HowToPlayFreePlay={storyCondition=function()
return true
end,detailCondition=function()
...
return false
end,radioList={"f2000_rtrg0010"}},GeneralPurposeRadio={storyCondition=function(e)
if e.demoName then
return true
end
return false
