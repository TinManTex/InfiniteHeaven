...
function e.OnNoticeSupporterFobSneaked()
  ...
  e.ShowNoticeFobSneaked"fobReqHelp"end
...
function e.Messages()
  ...
  end}},Trap=n,Network={{msg="NoticeSneakMotherBase",func=e.OnNoticeFobSneaked},{msg="NoticeSneakSupportedMotherBase",func=e.OnNoticeSupporterFobSneaked}}}
end
...
function e.OnFulton(t,a,n,o,M,_,r)
  ...
  e.DoFuncByFultonTypeSwitch(t,a,n,o,M,r,e.OnFultonSoldier,e.OnFultonVolgin,e.OnFultonHostage,e.OnFultonVehicle,e.OnFultonContainer,e.OnFultonGimmickCommon,e.OnFultonBuddy,e.OnFultonEnemyWalkerGear,e.OnFultonAnimal,e.OnFultonBossQuiet,e.OnFultonParasiteSquad)
end
