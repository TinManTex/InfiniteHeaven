...
function e.Messages()
  return Tpp.StrCode32Table{Player={{msg="FinishReflexMode",func=function()e.DispGuide("REFLEX_MODE",e.DISPLAY_OPTION.TIPS)
    end},{msg="IconCrawlStealthShown",func=function()e.DispGuide("STEALTH_MODE",e.DISPLAY_OPTION.TIPS)
    end},{msg="IconClimbOnShown",func=e.OnIconClimbOnShown},{msg="IconSwitchShown",func=e.OnIconSwitchShown},{msg="OnPlayerElude",func=function()e.DispGuide("ELUDE",e.DISPLAY_OPTION.TIPS)
      end},{msg="OnPlayerMachineGun",func=function()e.DispGuide("MACHINEGUN",e.DISPLAY_OPTION.CONTROL)
      end},{msg="OnPlayerMortar",func=function()e.DispGuide("MORTAR",e.DISPLAY_OPTION.CONTROL)
        end},{msg="OnPlayerGatling",func=function()e.DispGuide("ANTI_AIRCRAFT",e.DISPLAY_OPTION.CONTROL)
        end},{msg="OnPlayerSearchLight",func=function()e.DispGuide("SEARCH_LIGHT",e.DISPLAY_OPTION.TIPS_CONTROL)
          end},{msg="IconFultonShown",func=e.OnIconFultonShown},{msg="IconTBoxOnShown",func=function()e.DispGuide("TRASH",e.DISPLAY_OPTION.TIPS)
          end},{msg="IconToiletOnShown",func=function()e.DispGuide("TOILET",e.DISPLAY_OPTION.TIPS)
            end},{msg="OnVehicleDrive",func=e.OnVehicleDrive},{msg="OnWalkerGearDrive",func=function()e.DispGuide("DRIVE_WALKER_GEAR",e.DISPLAY_OPTION.PAUSE_CONTROL)
            end},{msg="OnCrawl",func=function()e.DispGuide("ROLLING",e.DISPLAY_OPTION.TIPS_CONTROL)
              ...
              end},{msg="WeaponPutPlaced",func=e.OnWeaponPutPlaced},{msg="OnAmmoStackEmpty",func=e.OnAmmoStackEmpty},{msg="OnPlayerHeliHatchOpen",func=function()e.DispGuide("MOVE_IN_HELI",e.DISPLAY_OPTION.CONTROL)
                end},{msg="OnPlayerPipeAction",func=function()e.DispGuide("PIPE_UP",e.DISPLAY_OPTION.CONTROL)
                end},{msg="OnPlayerToilet",func=function()e.DispGuide_PhatomCigar("PHANTOM_CIGAR_TOILET",e.DISPLAY_OPTION.TIPS)
                  end},{msg="OnPlayerTrashBox",func=function()e.DispGuide_PhatomCigar("PHANTOM_CIGAR_TRASH",e.DISPLAY_OPTION.TIPS)
                  end},{msg="PlayerHeliGetOff",func=e.OnPlayerHeliGetOff},{msg="NotHaveStaffToReceiveFulton",func=function()e.DispGuide("FULTON_CLASS_FUNCTION_STOP",e.DISPLAY_OPTION.TIPS)
                    end},{msg="SuppressorIsBroken",func=e.OnSuppressorIsBroken},{msg="IconWormholeOnShown",func=function()e.DispGuide("FOB_WORM_HOLE",e.DISPLAY_OPTION.TIPS)
                    end}},GameObject={{msg="StartInvestigate",func=e.StartInvestigate},{msg="EndInvestigate",func=e.EndInvestigate},{msg="BulletGuardArmor",func=e.OnBulletGuardArmor},{msg="Fulton",func=e.OnFultonRecovered},{msg="SaluteRaiseMorale",func=function()e.DispGuide("MORALE",e.DISPLAY_OPTION.TIPS)
    end},{msg="InAnimalLocator",func=e.InAnimalLocator},{msg="DiscoveredBySniper",func=e.OnDiscoveredBySniper},{msg="DiscoveredObject",func=e.OnDiscoveredObject},{msg="PlayerIsWithinRange",func=e.OnPlayerIsWithinRange}},Trap={{msg="Enter",sender="trap_Tips_CarryOverThrow_swamp",func=e.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0001",func=e.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0002",func=e.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0003",func=e.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0004",func=e.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0005",func=e.DispGuide_TrapCarryThrow}},Marker={{msg="ChangeToEnable",func=e.OnMarking}},Weather={{msg="ChangeWeather",func=e.DispGuide_Weather}},Radio={{msg="EspionageRadioPlay",func=e._UnregisterIntelRadioAfterPlayed},{msg="Start",func=e.OnRadioStart}},nil}
end
function e.DispGuide_TrapCarryThrow()
  if PlayerInfo.AndCheckStatus{PlayerStatus.CARRY}then
    ...
    local e=TppDefine.CONTROL_GUIDE_LANG_ID_LIST[e]TppUiCommand.CallButtonGuide(e)
  end
end
function e.DispGuide(n,i,_)
  ...
  elseif i==e.DISPLAY_OPTION.TIPS_CONTROL then
    e.DispControlGuide(n,T,E)e.DispTipsGuide(n,T,E)
...
function e.DispTipsGuide(n,i,S,O,T,_,p)
  local T=TppDefine.TIPS[n]if not T then
    return
  end
...
function e.DispControlGuide(n,_,i,p,O,S)
  local T=TppDefine.CONTROL_GUIDE[n]if not T then
    return
  end
...
function e.OnVehicleDrive(n,T)
  ...
  if e.AttackVehicleTable[T]then
    e.DispGuide("ATTACK_VEHICLE_SHOOT",e.DISPLAY_OPTION.CONTROL)e.DispGuide("ATTACK_VEHICLE_CAMERA",e.DISPLAY_OPTION.CONTROL)
  end
  e.DispGuide("DRIVE_COMMON_VEHICLE",e.DISPLAY_OPTION.PAUSE_CONTROL)
end
function e.OnStartCarryIdle()e.DispGuide("SHOULDER",e.DISPLAY_OPTION.CONTROL)e.DispGuide("SHOULDER_THROW",e.DISPLAY_OPTION.CONTROL)e.DispGuide("CARRY_WEAPON_LIMIT",e.DISPLAY_OPTION.TIPS)
end
...
function e.OnPlayerUseBoosterScope()e.DispGuide("BOOSTER_SCOPE",e.DISPLAY_OPTION.CONTROL)
end
...
function e.DispGuide_DayAndNight()e.DispGuide("DAY_NIGHT_SHIFT",e.DISPLAY_OPTION.TIPS)
end
function e.InAnimalLocator()e.DispGuide("SAVE_ANIMAL",e.DISPLAY_OPTION.TIPS)
end
...
function e.OnRadioStart(T)
  local T=e.RadioTipsMatchTable[T]if T then
...
function e.OpenTipsOnCurrentStory()
  local T=TppStory.GetCurrentStorySequence()e.OpenTipsOnStory(T)
end
function e.SetIgnoredControlGuideInMission(n,T,E)
  local T=TppDefine.CONTROL_GUIDE[T]if not T then
    return
  end
  if E then
...
function e.SetIgnoredGuideInMission(T,n,E)
  ...
  e.SetIgnoredTipsGuideInMission(T,n,E)e.SetIgnoredControlGuideInMission(T,n,E)
end
...
function e.SetIgnoredTipsGuideInMission(n,T,E)
  local T=TppDefine.TIPS[T]if not T then
    return
  end
  if E then
...
function e.MakeMessageExecTable()e.messageExecTable=Tpp.MakeMessageExecTable(e.Messages())
end
function e.OnReload(T)e.MakeMessageExecTable()e.OpenTipsOnCurrentStory()
end
function e.OnMessage(E,i,S,T,n,_,p)
  Tpp.DoMessage(e.messageExecTable,TppMission.CheckMessageOption,E,i,S,T,n,_,p)
end
function e.Init(T)e.MakeMessageExecTable()e.OpenTipsOnCurrentStory()e.SetEnemyHeliMessageWithinRange()
end
return e
