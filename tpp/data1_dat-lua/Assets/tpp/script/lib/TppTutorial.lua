...
function this.Messages()
  ...
  end}},GameObject={{msg="StartInvestigate",func=this.StartInvestigate},
  ...
  Trap={{msg="Enter",sender="trap_Tips_CarryOverThrow_swamp",func=this.DispGuide_TrapCarryThrow},
  ...
  Radio={{msg="EspionageRadioPlay",func=this._UnregisterIntelRadioAfterPlayed},
