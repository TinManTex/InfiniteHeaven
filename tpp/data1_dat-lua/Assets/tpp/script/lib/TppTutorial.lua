...
function this.Messages()
  return Tpp.StrCode32Table{Player={{msg="FinishReflexMode",func=function()
    this.DispGuide("REFLEX_MODE",this.DISPLAY_OPTION.TIPS)
  end},{msg="IconCrawlStealthShown",func=function()
    this.DispGuide("STEALTH_MODE",this.DISPLAY_OPTION.TIPS)
  end},{msg="IconClimbOnShown",func=this.OnIconClimbOnShown},{msg="IconSwitchShown",func=this.OnIconSwitchShown},{msg="OnPlayerElude",func=function()
    this.DispGuide("ELUDE",this.DISPLAY_OPTION.TIPS)
  end},{msg="OnPlayerMachineGun",func=function()
    this.DispGuide("MACHINEGUN",this.DISPLAY_OPTION.CONTROL)
  end},{msg="OnPlayerMortar",func=function()
    this.DispGuide("MORTAR",this.DISPLAY_OPTION.CONTROL)
  end},{msg="OnPlayerGatling",func=function()
    this.DispGuide("ANTI_AIRCRAFT",this.DISPLAY_OPTION.CONTROL)
  end},{msg="OnPlayerSearchLight",func=function()
    this.DispGuide("SEARCH_LIGHT",this.DISPLAY_OPTION.TIPS_CONTROL)
  end},{msg="IconFultonShown",func=this.OnIconFultonShown},{msg="IconTBoxOnShown",func=function()
    this.DispGuide("TRASH",this.DISPLAY_OPTION.TIPS)
  end},{msg="IconToiletOnShown",func=function()
    this.DispGuide("TOILET",this.DISPLAY_OPTION.TIPS)
  end},{msg="OnVehicleDrive",func=this.OnVehicleDrive},{msg="OnWalkerGearDrive",func=function()
    this.DispGuide("DRIVE_WALKER_GEAR",this.DISPLAY_OPTION.PAUSE_CONTROL)
  end},{msg="OnCrawl",func=function()
    this.DispGuide("ROLLING",this.DISPLAY_OPTION.TIPS_CONTROL)
  end},{msg="StartCarryIdle",func=this.OnStartCarryIdle},{msg="OnPickUpCollection",func=this.OnPickUpCollection},{msg="PlayerHoldWeapon",func=this.OnPlayerHoldWeapon},{msg="OnPlayerUseBoosterScope",func=this.OnPlayerUseBoosterScope},{msg="OnEquipItem",func=this.OnEquipItem},{msg="OnEquipHudClosed",func=this.OnEquipHudClosed},{msg="OnAmmoLessInMagazine",func=function()
    this.DispGuide("RELOAD",this.DISPLAY_OPTION.TIPS_CONTROL)
  end},{msg="WeaponPutPlaced",func=this.OnWeaponPutPlaced},{msg="OnAmmoStackEmpty",func=this.OnAmmoStackEmpty},{msg="OnPlayerHeliHatchOpen",func=function()
    this.DispGuide("MOVE_IN_HELI",this.DISPLAY_OPTION.CONTROL)
  end},{msg="OnPlayerPipeAction",func=function()
    this.DispGuide("PIPE_UP",this.DISPLAY_OPTION.CONTROL)
  end},{msg="OnPlayerToilet",func=function()
    this.DispGuide_PhatomCigar("PHANTOM_CIGAR_TOILET",this.DISPLAY_OPTION.TIPS)
  end},{msg="OnPlayerTrashBox",func=function()
    this.DispGuide_PhatomCigar("PHANTOM_CIGAR_TRASH",this.DISPLAY_OPTION.TIPS)
  end},{msg="PlayerHeliGetOff",func=this.OnPlayerHeliGetOff},{msg="NotHaveStaffToReceiveFulton",func=function()
    this.DispGuide("FULTON_CLASS_FUNCTION_STOP",this.DISPLAY_OPTION.TIPS)
  end},{msg="SuppressorIsBroken",func=this.OnSuppressorIsBroken},{msg="IconWormholeOnShown",func=function()
    this.DispGuide("FOB_WORM_HOLE",this.DISPLAY_OPTION.TIPS)
  end}},GameObject={{msg="StartInvestigate",func=this.StartInvestigate},{msg="EndInvestigate",func=this.EndInvestigate},{msg="BulletGuardArmor",func=this.OnBulletGuardArmor},{msg="Fulton",func=this.OnFultonRecovered},{msg="SaluteRaiseMorale",func=function()
    this.DispGuide("MORALE",this.DISPLAY_OPTION.TIPS)
  end},{msg="InAnimalLocator",func=this.InAnimalLocator},{msg="DiscoveredBySniper",func=this.OnDiscoveredBySniper},{msg="DiscoveredObject",func=this.OnDiscoveredObject},{msg="PlayerIsWithinRange",func=this.OnPlayerIsWithinRange}},Trap={{msg="Enter",sender="trap_Tips_CarryOverThrow_swamp",func=this.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0001",func=this.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0002",func=this.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0003",func=this.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0004",func=this.DispGuide_TrapCarryThrow},{msg="Enter",sender="trap_Tips_CarryOverThrow_tent0005",func=this.DispGuide_TrapCarryThrow}},Marker={{msg="ChangeToEnable",func=this.OnMarking}},Weather={{msg="ChangeWeather",func=this.DispGuide_Weather}},Radio={{msg="EspionageRadioPlay",func=this._UnregisterIntelRadioAfterPlayed},{msg="Start",func=this.OnRadioStart}},nil}
end
