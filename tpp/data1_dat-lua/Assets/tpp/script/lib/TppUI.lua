...
function e.Messages()
  return Tpp.StrCode32Table{
    GameObject={{msg="ArrivedAtLandingZoneWaitPoint",sender="SupportHeli",func=function()
      e.ShowAnnounceLog"heliArrivedLZ"
    end}},
    UI={
      {msg="EndFadeIn",func=e.EnableGameStatusOnFade,option={isExecMissionClear=true,isExecDemoPlaying=true,isExecGameOver=true}},{msg="EndFadeOut",func=e.DisableGameStatusOnFadeOutEnd,option={isExecMissionClear=true,isExecDemoPlaying=true,isExecGameOver=true}},{msg="ConfigurationUpdated",func=function()
...
function e.FadeIn(o,i,a,n)
  ...
  TppSoundDaemon.ResetMute"Outro"s(o,i,a)
...
function e.GetTaskCompletedNumber(e)
  local n=TppDefine.MISSION_ENUM[tostring(e)]if not n then
    return 0
  end
  local e=0
...
function e.ShowControlGuide(n)
  ...
  local n=TppDefine.CONTROL_GUIDE_LANG_ID_LIST[e]if n==nil then
    return
  end
  if a then
...
function e.OpenTips(n)
  ...
  local n=TppDefine.TIPS_ON_STORY_LANG_ID_LIST[n]e.RegisterTips(n)
end
