...
s[10010]=function(p)
  if TppPackList.IsMissionPackLabel"afterMissionClearMovie"then
    ...
    local s={{636,0,0,1}}
    local p={{300,1},{301,1},{302,1},{303,1},{304,1},{305,1},{306,1},{307,1},{308,1},{309,1},{310,1},{311,1},{312,1},{313,1},{314,1},{315,1},{316,1},{317,1},{318,1},{319,1},{320,1},{321,1},{322,1},{323,1},{324,1},{325,1},{326,1},{327,1},{328,1},{329,1},{330,1},{331,1},{332,1},{333,1},{334,1},{337,1},{338,1},{339,1},{340,1},{341,1},{342,1},{343,1},{344,1},{345,1},{346,1},{347,1},{348,1},{349,1},{380,1},{381,1}}
...
s[10086]=function(p)
  ...
  TppPackList.AddDefaultMissionAreaPack(p)do
    ...
    local s={{type="hostage",name=p,faceId=610,bodyId=111},{type="hostage",name=s,faceId=611,bodyId=111},{type="hostage",name=e,faceId=612,bodyId=111},{type="hostage",name=i,faceId="female",bodyId=113},{type="enemy",name=a,faceId=609,bodyId=255},{type="enemy",name=t,faceId=629,bodyId=TppEnemyBodyId.pfs0_unq_v155}}
    TppEneFova.AddUniqueSettingPackage(s)
  end
end
s[10082]=function(p)
...
s[10100]=function(p)
  ...
  TppPackList.AddDefaultMissionAreaPack(p)do
    ...
    local s={{type="enemy",name=o,faceId=616,bodyId=251},{type="hostage",name=t,faceId=s,bodyId=130},{type="hostage",name=e,faceId=s,bodyId=131},{type="hostage",name=i,faceId=s,bodyId=132},{type="hostage",name=p,faceId=s,bodyId=133},{type="hostage",name=a,faceId=s,bodyId=134}}
    TppEneFova.AddUniqueSettingPackage(s)
  end
...
s[10115]=function(p)
  ...
  TppPackList.AddFOBLayoutPack(p)do
    ...
    local s={{type="hostage",name=t,faceId="dd",bodyId=143},{type="hostage",name=i,faceId="dd",bodyId=143},{type="hostage",name=e,faceId="dd",bodyId=143},{type="hostage",name=p,faceId="dd",bodyId=143},{type="hostage",name=a,faceId="dd",bodyId=143},{type="hostage",name=s,faceId="dd",bodyId=143}}
    TppEneFova.AddUniqueSettingPackage(s)
  end
end
s[10120]=function(p)
...
s[65020]={"/Assets/tpp/pack/show/e3_2014/s65020/s65020_area.fpk","/Assets/tpp/pack/location/afgh/pack_common/afgh_script.fpk"}
