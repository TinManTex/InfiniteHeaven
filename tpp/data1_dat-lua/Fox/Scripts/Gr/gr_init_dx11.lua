    ...
    allSettings={
      {settingName="PluginShadow",
        settingTable={
          ...
          {name="ExtraHigh",DirectionalLightShadowResolution=8192,SpotLightLightShadowResolution=4096,PointLightLightShadowResolution=8192,CascadeShadowRangeScale=4,EnableCascadeShadowBlend=1}
