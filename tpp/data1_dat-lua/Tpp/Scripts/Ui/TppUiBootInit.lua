...
local m=AssetConfiguration.GetDefaultCategory"Language"local s=""local o=""local _=""local p=""local n=""local a=""local i=1
local t=3
local e="/Assets/tpp"if TppSystemUtility.GetCurrentGameMode()=="MGO"then
  e="/Assets/mgo"end
local T=e.."/pack/ui/lang/lang_default_data_eng.fpk"if m=="jpn"then
  s="FontSystem_KanjiFont"o="/Assets/tpp/font/font_def_jp.ffnt"_="FontSystem_Slot3"p="/Assets/tpp/font/KanjiFont.ffnt"i=2
  t=3
  T=e.."/pack/ui/lang/lang_default_data_jpn.fpk"elseif m=="eng"then
...
elseif m=="rus"then
  ...
  t=3
  T=e.."/pack/ui/lang/lang_default_data_rus.fpk"elseif m=="ara"then
  s="FontSystem_LatinFont"o="/Assets/tpp/font/arabia.ffnt"_="FontSystem_Slot3"p="/Assets/tpp/font/arabia.ffnt"i=1
  t=3
  T=e.."/pack/ui/lang/lang_default_data_ara.fpk"else
  s="FontSystem_LatinFont"o="/Assets/tpp/font/font_def_ltn.ffnt"_="FontSystem_Slot3"p="/Assets/tpp/font/LatinFont.ffnt"i=1
  t=3
end
