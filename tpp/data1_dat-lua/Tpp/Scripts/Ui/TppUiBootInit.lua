...
LanguageBlock.Create(600*1024)LanguageBlock.Create(96*1024)
...
if m=="jpn"then
  ...
  _="FontSystem_Slot3"
  p="/Assets/tpp/font/KanjiFont.ffnt"i
  =2
  t=3
...
elseif m=="rus"then
  ...
  _="FontSystem_Slot3"p="/Assets/tpp/font/russian.ffnt"
  T="FontSystem_KanjiFont"a="/Assets/tpp/font/font_def_ltn.ffnt"
  i=1
  t=3
...
elseif m=="ara"then
  ...
  _="FontSystem_Slot3"
  p="/Assets/tpp/font/arabia.ffnt"i=1
  t=3
