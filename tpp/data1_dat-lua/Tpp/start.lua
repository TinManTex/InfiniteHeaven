...
PhDaemon.SetUpdateDtMax(1/15)PhDaemon.SetWorldMin(Vector3(-4200,-1e3,-4200))PhDaemon.SetWorldMax(Vector3(4200,3e3,4200))e.SetCollisionGroupState(1,3,false)e.SetCollisionGroupState(1,4,true)e.SetCollisionGroupState(1,6,true)e.SetCollisionGroupState(3,3,true)e.SetCollisionGroupState(3,4,true)e.SetCollisionGroupState(3,5,true)e.SetCollisionGroupState(6,3,false)e.SetCollisionGroupState(6,9,false)e.SetCollisionGroupState(7,1,false)e.SetCollisionGroupState(7,2,false)e.SetCollisionGroupState(7,3,false)e.SetCollisionGroupState(7,4,false)e.SetCollisionGroupState(7,5,false)e.SetCollisionGroupState(7,6,false)e.SetCollisionGroupState(7,8,false)e.SetCollisionGroupState(7,9,false)e.SetCollisionGroupState(7,10,false)e.SetCollisionGroupState(9,3,false)e.SetCollisionGroupState(9,10,false)e.SetCollisionGroupState(10,9,false)e.SetCollisionGroupState(11,3,true)e.SetCollisionGroupState(11,4,true)e.SetCollisionGroupState(11,5,true)e.SetCollisionGroupState(12,3,true)e.SetCollisionGroupState(12,4,true)e.SetCollisionGroupState(12,5,true)
...
if Editor then
  ...
  local e=t:CreateBucket("SetupBucket",e)e:LoadProjectFile"/Assets/tpp/level/location/SetupLocation2.fxp"
end
if a=="Windows"then
...
Gimmick.RegisterCassetteToRadio("afgh_radi001_csst001_gim_n0000|srt_afgh_radi001_csst001","/Assets/tpp/level/location/mtbs/block_large/mtbs_qrntnFacility_gimmick.fox2",31)t()
