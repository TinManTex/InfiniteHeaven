...
if not quest_q52130_EXTERNAL then
	InfCore.Log("ERROR quest_q52130_EXTERNAL == nil")--DEBUGNOW
else
	InfCore.Log("using quest_q52130_EXTERNAL")--DEBUGNOW
	return quest_q52130_EXTERNAL
end
