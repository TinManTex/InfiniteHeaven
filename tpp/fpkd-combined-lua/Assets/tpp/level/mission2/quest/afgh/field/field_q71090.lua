...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 473.343, cpPosition_y = 322.275, cpPosition_z = 1061.975, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 473.343, cpPosition_y = 322.275, cpPosition_z = 1061.975, gtPosition_r = 50.0,
		},
	},
