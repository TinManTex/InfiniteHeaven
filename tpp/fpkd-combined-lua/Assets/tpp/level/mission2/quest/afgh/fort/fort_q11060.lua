...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1822.255, cpPosition_y = 464.872, cpPosition_z = -1252.873, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1822.255, cpPosition_y = 464.872, cpPosition_z = -1252.873, cpPosition_r = 50.0,
		},
	},
	...
	enemyList = {
		...
		{ 
			...
			route_d = "rt_quest_d_0005", 	route_c = "rt_quest_c_0004",
			powerSetting = { "QUEST_ARMOR", "MG" },
		},
	},
