...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 2080.718, cpPosition_y = 456.726, cpPosition_z = -1927.582, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 2080.718, cpPosition_y = 456.726, cpPosition_z = -1927.582, gtPosition_r = 50.0,
		},
	},
