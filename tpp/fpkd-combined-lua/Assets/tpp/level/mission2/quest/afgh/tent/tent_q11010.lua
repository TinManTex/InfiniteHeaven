...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1054.461, cpPosition_y = 290.648, cpPosition_z = 1469.108, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1054.461, gtPosition_y = 290.648, gtPosition_z = 1469.108, gtPosition_r = 50.0,
		},
	},
