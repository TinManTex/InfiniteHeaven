...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -869.643, cpPosition_y = 287.903, cpPosition_z = 1960.858, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -869.643, cpPosition_y = 287.903, cpPosition_z = 1960.858, gtPosition_r = 50.0,
		},
	},
