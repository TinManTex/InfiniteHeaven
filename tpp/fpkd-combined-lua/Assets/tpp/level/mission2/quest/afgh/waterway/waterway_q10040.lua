...
this.QUEST_TABLE = {
	...
	enemyList = {
		{ 
			...
			route_d = "rt_quest_d_0000", 	route_d = "rt_quest_d_0000",
		...
		{ 
			...
			route_d = "rt_quest_d_0001", 	route_d = "rt_quest_d_0001",
			cpName = "afgh_waterwayEast_ob",
			isBalaclava = false,
		...
		{ 
			...
			route_d = "rt_quest_d_0002", 	route_d = "rt_quest_d_0002",
			cpName = "afgh_waterwayEast_ob",
			isBalaclava = false,
		...
		{ 
			...
			route_d = "rt_quest_d_0004", 	route_d = "rt_quest_d_0004",
			cpName = "afgh_waterwayEast_ob",
			isBalaclava = false,
			powerSetting = { "HELMET" },
		},
		{ 
			...
			route_d = "rt_quest_d_0005", 	route_d = "rt_quest_d_0005",
			cpName = "afgh_waterwayEast_ob",
			isBalaclava = false,
			powerSetting = { "HELMET" },
		},
		{ 
			...
			route_d = "rt_quest_d_0006", 	route_d = "rt_quest_d_0006",
			cpName = "afgh_waterwayEast_ob",
			isBalaclava = false,
			powerSetting = { "HELMET" },
		},
...
quest_step.QStep_Start = {
	OnEnter = function()
		...
		TppUiCommand.RegisterIconUniqueInformation{ markerId = GameObject.GetGameObjectId("sol_quest_0000"), langId = "marker_ene_elite" }
