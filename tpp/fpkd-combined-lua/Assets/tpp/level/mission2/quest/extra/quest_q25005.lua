...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 967.334, cpPosition_y = -11.938, cpPosition_z = 1269.883, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 967.334, gtPosition_y = -11.938, gtPosition_z = 1269.883, gtPosition_r = 70.0,
		},
	},
