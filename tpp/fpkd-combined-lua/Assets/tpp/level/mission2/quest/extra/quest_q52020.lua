...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -392.343, cpPosition_y = 1.348, cpPosition_z = 467.119, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -392.343, gtPosition_y = 1.348, gtPosition_z = 467.119, gtPosition_r = 70.0,
		},
	},
