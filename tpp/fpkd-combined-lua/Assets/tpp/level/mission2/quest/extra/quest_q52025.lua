...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -608.622, cpPosition_y = 278.374, cpPosition_z = 1694.876, cpPosition_r = 30.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -608.622, gtPosition_y = 278.374, gtPosition_z = 1694.876, gtPosition_r = 30.0,
		},
	},
