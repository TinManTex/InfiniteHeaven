...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = -1865.873, cpPosition_y = 329.202, cpPosition_z = 521.377, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = -1865.873, gtPosition_y = 329.202, gtPosition_z = 521.377, gtPosition_r = 50.0,
		},
	},
