...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 672.542, cpPosition_y = -3.727, cpPosition_z = 108.875, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 672.542, gtPosition_y = -3.727, gtPosition_z = 108.875, gtPosition_r = 70.0,
		},
	},
