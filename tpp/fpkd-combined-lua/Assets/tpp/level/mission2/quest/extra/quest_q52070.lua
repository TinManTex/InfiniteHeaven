...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 2330.478, cpPosition_y = 60.072, cpPosition_z = 276.123, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 2330.478, gtPosition_y = 60.072, gtPosition_z = 276.123, gtPosition_r = 70.0,
		},
	},
