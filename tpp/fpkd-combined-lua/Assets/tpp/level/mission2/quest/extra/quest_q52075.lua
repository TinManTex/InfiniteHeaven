...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1349.260, cpPosition_y = 11.259, cpPosition_z = 285.945, cpPosition_r = 70.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1349.260, gtPosition_y = 11.259, gtPosition_z = 285.945, gtPosition_r = 70.0,
		},
	},
