...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1198.031, cpPosition_y = -11.928, cpPosition_z = 1543.384, cpPosition_r = 90.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1198.031, gtPosition_y = -11.928, gtPosition_z = 1543.384, gtPosition_r = 90.0,
