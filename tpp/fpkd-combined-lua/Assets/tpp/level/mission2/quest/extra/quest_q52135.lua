...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 1397.000, cpPosition_y =  299.508, cpPosition_z = 1913.398, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 1397.000, gtPosition_yc = 299.508, gtPosition_z = 1913.398, gtPosition_r = 50.0,
