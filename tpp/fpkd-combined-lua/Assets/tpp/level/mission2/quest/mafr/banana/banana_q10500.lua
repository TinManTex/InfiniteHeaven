...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 846.970, cpPosition_y = 36.452, cpPosition_z = -917.762, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 846.970, gtPosition_y = 36.452, gtPosition_z = -917.762, gtPosition_r = 30.0,
		},
	},
...
quest_step.QStep_Start = {
	OnEnter = function()
		...
		TppUiCommand.RegisterIconUniqueInformation{ markerId = GameObject.GetGameObjectId("sol_quest_0002"), langId = "marker_ene_elite" }
