...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 567.262, cpPosition_y = 78.876, cpPosition_z = -1070.614, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 567.262, cpPosition_y = 78.876, cpPosition_z = -1070.614, cpPosition_r = 50.0,
		},
	},
	...
	enemyList = {
		...
		{ 
			...
			route_d = "rt_quest_d_0001", 	route_c = "rt_quest_c_0002",
			powerSetting = { "QUEST_ARMOR", "SHOTGUN" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0003",
			route_d = "rt_quest_d_0003", 	route_c = "rt_quest_c_0001",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0004",
			route_d = "rt_quest_d_0004", 	route_c = "rt_quest_c_0000",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{ 
			enemyName = "sol_quest_0005",
			route_d = "rt_quest_d_0005", 	route_c = "rt_quest_c_0000",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
		{ 
		...
		{ 
			...
			route_d = "rt_quest_d_0007", 	route_c = "rt_quest_c_0001",
			powerSetting = { "QUEST_ARMOR", "MG" },
			soldierSubType = "PF_C",
		},
	},
