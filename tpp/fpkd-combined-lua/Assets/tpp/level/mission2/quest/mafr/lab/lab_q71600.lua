...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 2522.474, cpPosition_y = 100.128, cpPosition_z = -896.065, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 2522.474, gtPosition_y = 100.128, gtPosition_z = -896.065, gtPosition_r = 50.0,
		},
	},
