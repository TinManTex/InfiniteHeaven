...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 2746.635, cpPosition_y = 180.042, cpPosition_z = -2401.350, cpPosition_r = 50.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 2746.635, gtPosition_y = 180.042, gtPosition_z = -2401.350, gtPosition_r = 50.0,
		},
	},
