...
this.QUEST_TABLE = {
	...
	cpList = {
		{
			cpName = "quest_cp",
			cpPosition_x = 224.554, cpPosition_y = 20.449, cpPosition_z = -934.963, cpPosition_r = 20.0,
			isOuterBaseCp = true,
			gtName = "gt_quest_0000",
			gtPosition_x = 224.554, gtPosition_y = 20.449, gtPosition_z = -934.963, gtPosition_r = 20.0,
		},
	},
