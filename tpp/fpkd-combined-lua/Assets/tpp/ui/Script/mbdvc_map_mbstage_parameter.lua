...
mbdvc_map_mbstage_parameter = {
  missionParameters={--tex pulled out of GetMissionParameter
    [10115]={
      heliLandPoint={--was heliLandPointTable_RetakePlatform
        {--layout0
          { --cluster
          },
          {
    ...
    [30050]={
      heliLandPoint={--was heliLandPointTable_FreePlay
        {--layout
          { --cluster
            { --plant
    ...
    [30150]={
      heliLandPoint={--was heliLandPointTable_f30150
    ...
    [30250]={
      heliLandPoint={--was heliLandPointTable_f30250
  ...
  GetMissionParameter = function( parameterTable )
    ...
    local clusterGradeList = {
      parameterTable.commandClusterGrade,
      parameterTable.combatClusterGrade,
      parameterTable.developClusterGrade,
      parameterTable.supportClusterGrade,
      parameterTable.medicalClusterGrade,
      parameterTable.spyClusterGrade,
      parameterTable.baseDevClusterGrade,
    }
    ...
    if missionId == 30050 then
      ...
      local heliLandPointparameterTable = mbdvc_map_mbstage_parameter.missionParameters[missionId].heliLandPoint
      ...
      for ClusterIndex, ClusterData in ipairs( layoutDataTable ) do
        local clusterGradeIndex = clusterGradeList[ClusterIndex]
            ...
            if gradeCount < clusterGradeIndex then
              for i, heliLandPointData in ipairs( gradeData ) do
                if heliLandPointData.disableClusterIndex then
                  local disableClusterIndex = clusterGradeList[heliLandPointData.disableClusterIndex]
      ...
      table.insert( heliLandPointTable, mbdvc_map_mbstage_parameter.missionParameters[30250].heliLandPoint[1]) --was heliLandPointTable_f30250[1] --GOTCHA:
    ...
    elseif missionId == 10115 then
      ...
      local Clustergrade = clusterGradeList[ClusterIndex +1]
