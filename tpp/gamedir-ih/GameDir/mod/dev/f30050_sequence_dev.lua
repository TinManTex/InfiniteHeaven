...
--f30050_sequence.lua --DEBUGNOW f30050_sequence_dev.lua
--DEBUGNOW
if false then 
...
--return InfCore.PCall(function()--tex DEBUGNOW
local this = {}
...
local STAGE_PACK_INDEX = {
  ...
  DEMO = 1,
  BATTLE_HANGER = 2,
  INTERIOR = 3,--tex mb interior addon
}
...
function this.OnRestoreSVars()
  ...
  if gvars.f30050_missionPackIndex ~= STAGE_PACK_INDEX.BATTLE_HANGER and gvars.f30050_missionPackIndex~=STAGE_PACK_INDEX.INTERIOR then--tex added and ~= INTERIOR-- DEBUGNOW think this through
