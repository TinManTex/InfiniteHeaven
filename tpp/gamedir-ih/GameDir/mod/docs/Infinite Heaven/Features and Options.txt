...
4:Appearance menu
5:Cam - AroundCam menu
6:Cam - PlayCam menu
7:Cam - Player Cam hook menu
8:Customize menu
9:Cutscenes menu
10:Debug menu
11:Enemy Prep menu
12:Enemy phases menu
13:Enemy reinforcements menu
14:Events menu
15:Fulton menu
16:Mission-prep features menu
17:Mother Base menu
18:Patrols and deployments menu
19:Player restrictions menu
20:Player settings menu
21:Progression menu
22:RouteSet menu
23:Side ops menu
24:Soldier parameters menu
...
7:Select profile >! All_Options_Example - Copy.lua, All_Options_Example.lua, CustomPrep_Max.lua, CustomPrep_Min.lua, CustomPrep_Wide.lua, Fulton_Heaven.lua, MotherBase_Heaven.lua, Parasite_Hard.lua, Revenge_Heaven.lua, Subsistence_Bounder.lua, Subsistence_Game.lua, Subsistence_Pure.lua, User_Saved.lua
...
3:Camo type <> 
4:Headgear <> 0-100
5:Filter faces = Show all, Headgear (cosmetic), Unique, Head fova mods
6:Face <> 0-0
...
18:Disable mode text feedback = Off, On
...
Applies FOV(degrees) proportionally to the different cam mode focal lengths.
...
7:Custom soldier type in Free roam = OFF, RANDOM, DRAB, TIGER, SNEAKING_SUIT, BATTLE_DRESS, SWIMWEAR, SWIMWEAR2, SWIMWEAR3, PFA_ARMOR, SOVIET_A, SOVIET_B, PF_A, PF_B, PF_C, SOVIET_BERETS, SOVIET_HOODIES, SOVIET_ALL, PF_MISC, PF_ALL, MSF_GZ, MSF_TPP, XOF, XOF_GASMASK, XOF_GZ, GENOME_SOLDIER, PF_ALL_TEST
Override the soldier type of enemy soldiers in Free Roam.
New soldier types can be added via the bodyInfo addon system.
8:Custom soldier type in Missions = OFF, RANDOM, DRAB, TIGER, SNEAKING_SUIT, BATTLE_DRESS, SWIMWEAR, SWIMWEAR2, SWIMWEAR3, PFA_ARMOR, SOVIET_A, SOVIET_B, PF_A, PF_B, PF_C, SOVIET_BERETS, SOVIET_HOODIES, SOVIET_ALL, PF_MISC, PF_ALL, MSF_GZ, MSF_TPP, XOF, XOF_GASMASK, XOF_GZ, GENOME_SOLDIER, PF_ALL_TEST
...
4:DD Suit = OFF, RANDOM, DRAB, TIGER, SNEAKING_SUIT, BATTLE_DRESS, SWIMWEAR, SWIMWEAR2, SWIMWEAR3, PFA_ARMOR, SOVIET_A, SOVIET_B, PF_A, PF_B, PF_C, SOVIET_BERETS, SOVIET_HOODIES, SOVIET_ALL, PF_MISC, PF_ALL, MSF_GZ, MSF_TPP, XOF, XOF_GASMASK, XOF_GZ, GENOME_SOLDIER, PF_ALL_TEST
New body types can be added via the bodyInfo addon system.
5:DD Suit female = OFF, RANDOM, DRAB_FEMALE, TIGER_FEMALE, SNEAKING_SUIT_FEMALE, BATTLE_DRESS_FEMALE, SWIMWEAR_FEMALE, SWIMWEAR2_FEMALE, SWIMWEAR3_FEMALE
New body types can be added via the bodyInfo addon system.
...
9:Appearance menu
10:Buddy menu
11:Cam - AroundCam menu
12:Cam - PlayCam menu
13:Cam - Player Cam hook menu
14:Debug stuff menu
15:Enemy phases menu
16:Fulton success menu
17:MB Ocean menu
18:Markers menu
19:Misc menu
20:Motions menu
21:Object lists menu
22:Player restrictions menu
23:RouteSet menu
24:Soldier parameters menu
25:Staff menu
26:Support heli menu
27:Time scale menu
28:Weather menu
29:foxTearDownMenu > 
30:reloadTableMenu
