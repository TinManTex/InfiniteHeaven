...
InfCore.LogFlow"TppPlayer2CallbackScript"--tex DEBUG
--DEBUGNOW wrap this in a pcall?
--NMC: weird setup, TppPlayer2InitialzeScript is dofiled in start2nd
--this file is loaded by engine after TppPlayer2InitialzeScript Player.RegisterScriptFunc
--then this sets TppPlayer2CallbackScript as a global table directly instead of returning table to whatever loaded it
...
InfCore.LogFlow"TppPlayer2CallbackScript done"--tex DEBUG
