...
function this.RuntimeAnalyzeClasses()
  ...
  InfCore.Log("IHRuntimeAnalyze.RuntimeAnalyzeClasses:")
  ...
  --  --tex calling GetRenderName with . instead of : 'ERROR: bad argument #1 to 'GetRenderName' (Entity expected, got no value)'
