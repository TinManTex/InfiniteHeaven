...
local this={
  questPackList={  
    ...
    "/Assets/tpp/pack/mission2/quest/ih/quest_IH0005_ruins_uav_wanderer.fpk",--quest fpk
 ...
 --iconPos=Vector3(-1836.664,358.543,-326.481),--shufap
  iconPos=Vector3(1332.480,296.560,2160.653),--afgh ruins dester wanderer
  radius=5,--radius of the quest area circle
