function this.ApplyPowerSetting(soldierId,powerSettings)
  ...
  for e,t in pairs(o)do
    if powerLoadout[e]and not mvars.revenge_loadedEquip[e]then
      powerLoadout[e]=nil
    end
  end
  ...
  local n=0
  local o=this.GetBodyId(soldierId,soldierType,subTypeName,powerSettings)
  local p=this.GetFaceId(soldierId,soldierType,subTypeName,powerSettings)
  local l=this.GetBalaclavaFaceId(soldierId,soldierType,subTypeName,powerSettings)
  local r,s,e=this.GetWeaponId(soldierId,powerSettings)
  ...
  if(r~=nil or secondaryWeapon~=nil)or e~=nil then
    GameObject.SendCommand(soldierId,{id="SetEquipId",primary=r,secondary=s,tertiary=e})
  end
  GameObject.SendCommand(soldierId,{id="ChangeFova",bodyId=o,faceId=p,balaclavaFaceId=l})
  ...
  GameObject.SendCommand(soldierId,{id="SetSoldier2SubType",type=e[subTypeName]})
end
